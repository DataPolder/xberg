...
def test_framework_env_drift_changes_cell_even_when_artifact_name_is_unchanged() -> None:
...
def test_benchmark_steps_cannot_suppress_failures() -> None:
...
def test_artifacts_must_be_validated_before_consolidation() -> None:
    mutated = (
        WORKFLOW.replace(
