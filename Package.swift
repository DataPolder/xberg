...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/xberg/releases/download/v1.0.0-rc.40/Xberg-rs.artifactbundle.zip",
      checksum: "e689cf5368b45c153d6b75062579002bab2a3722c4edb4e6f34e3e9ce00128b6"
    ),
