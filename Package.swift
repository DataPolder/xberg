...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/xberg/releases/download/v1.0.0-rc.42/Xberg-rs.artifactbundle.zip",
      checksum: "6c61937aa56e1d2a86c3795024c69f1f2d7bd365697796b582f1acb33a8010ca"
    ),
