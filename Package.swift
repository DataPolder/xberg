...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/xberg/releases/download/v1.0.0-rc.38/Xberg-rs.artifactbundle.zip",
      checksum: "0b3a557def6dc0043543d1947d362e810caab2a15f39398822e70b443472de1e"
    ),
