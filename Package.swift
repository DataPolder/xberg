...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/xberg/releases/download/v1.0.11/Xberg-rs.artifactbundle.zip",
      checksum: "a568d5a6b463e73760d5b21e660c9bcf36388db2907549db347adf9c450866eb"
    ),
