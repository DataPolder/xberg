...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/xberg/releases/download/v1.0.0/Xberg-rs.artifactbundle.zip",
      checksum: "e32362641c01c633af3c0e00d02a352953decf833ed34baf90af043ca420c9a3"
    ),
