...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/xberg/releases/download/v1.0.9/Xberg-rs.artifactbundle.zip",
      checksum: "43eb420caeaa006ead7bebbb90c0419126d828c899843caeca1d317a7cf0210f"
    ),
