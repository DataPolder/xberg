...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/xberg/releases/download/v1.0.1/Xberg-rs.artifactbundle.zip",
      checksum: "9b54d9bab51f9661f523cd82e6126fd7fc88417f2a4c0821a9d2633fe26ee219"
    ),
