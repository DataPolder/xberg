...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/xberg/releases/download/v1.0.3/Xberg-rs.artifactbundle.zip",
      checksum: "c54f6042a6963deb492570be4b6aaee58a226d4dd1d85efe245b932a8f0e1a14"
    ),
