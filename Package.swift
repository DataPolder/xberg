...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/xberg/releases/download/v1.0.0-rc.41/Xberg-rs.artifactbundle.zip",
      checksum: "bc5e01e95170544bd5e961a937aea3fa45d75800c0d18fefa969705c1803f632"
    ),
