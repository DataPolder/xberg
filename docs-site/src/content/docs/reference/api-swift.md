...
<!-- alef:hash:58b689d200ed2aad10b40ca9ac234b2eee33fcb1f469ee54c2470f60ff6e9fc1 -->
...
```swift
public static func takeXbergNativePdfRenderWarnings() -> [ProcessingWarning]
```

**Example:**

```swift
let result = takeXbergNativePdfRenderWarnings()
```
