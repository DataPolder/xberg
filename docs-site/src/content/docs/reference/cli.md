...
<!-- alef:hash:215c7b12e34462243788bf7959894ffc03a86df9764299145c4428e5eef25de4 -->
...
| `pdf_backend` | `--pdf-backend` | `Option<String>` |  | PDF extraction backend to use: "native" (default, the only implemented backend) or "pdfium". |
