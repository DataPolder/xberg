...
<!-- alef:hash:0eac2ab8c367a7692f060f148ae903698f01b5ad165fc7fa8295bda03ad828aa -->
...
```zig
pub fn take_engine_render_warnings() []const ProcessingWarning
```
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `version` | `\[:0\]const u8` | Yes | `"pp-ocrv6"` (default) or `"pp-ocrv5"`. Under `"pp-ocrv6"`, `model_tier` selects among `"medium"`/`"small"`/`"tiny"`. |
