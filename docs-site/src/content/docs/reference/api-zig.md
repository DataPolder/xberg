...
```zig
pub fn ensure_initialized() HwpError!void
```
...
```zig
pub fn clear_embedding_backends() HwpError!void
```
...
```zig
pub fn list_embedding_backends() HwpError![]const [:0]const u8
```
...
```zig
pub fn register_document_extractor(extractor: DocumentExtractor) HwpError!void
```
...
```zig
pub fn unregister_document_extractor(name: [:0]const u8) HwpError!void
```
...
```zig
pub fn list_document_extractors() HwpError![]const [:0]const u8
```
...
```zig
pub fn clear_document_extractors() HwpError!void
```
...
```zig
pub fn list_ocr_backends() HwpError![]const [:0]const u8
```
...
```zig
pub fn clear_ocr_backends() HwpError!void
```
...
```zig
pub fn list_post_processors() HwpError![]const [:0]const u8
```
...
```zig
pub fn clear_post_processors() HwpError!void
```
...
```zig
pub fn register_renderer(renderer: Renderer) HwpError!void
```
...
```zig
pub fn unregister_renderer(name: [:0]const u8) HwpError!void
```
...
```zig
pub fn list_renderers() HwpError![]const [:0]const u8
```
...
```zig
pub fn clear_renderers() HwpError!void
```
...
```zig
pub fn clear_reranker_backends() HwpError!void
```
...
```zig
pub fn list_reranker_backends() HwpError![]const [:0]const u8
```
...
```zig
pub fn clear_tokenizer_backends() HwpError!void
```
...
```zig
pub fn list_tokenizer_backends() HwpError![]const [:0]const u8
```
...
```zig
pub fn list_validators() HwpError![]const [:0]const u8
```
...
```zig
pub fn clear_validators() HwpError!void
```
...
```zig
pub fn classify_chunks(result: ExtractedDocument, config: ChunkClassificationConfig) HwpError!void
```
...
```zig
pub fn extract(self: *const DocumentExtractor, input: ExtractInput, config: ExtractionConfig) HwpError!ExtractedDocument
```
...
```zig
pub fn embed(self: *const EmbeddingBackend, texts: []const [:0]const u8) HwpError![]const []const f32
```
...
```zig
pub fn validate(self: *const HeuristicsConfig) HwpError!void
```
...
```zig
pub fn processImage(self: *const OcrBackend, image_bytes: []const u8, config: OcrConfig) HwpError!ExtractedDocument
```
...
```zig
pub fn processImageFile(self: *const OcrBackend, path: [:0]const u8, config: OcrConfig) HwpError!ExtractedDocument
```
...
```zig
pub fn processDocument(self: *const OcrBackend, path: [:0]const u8, config: OcrConfig) HwpError!ExtractedDocument
```
...
```zig
pub fn initialize(self: *const Plugin) HwpError!void
```
...
```zig
pub fn shutdown(self: *const Plugin) HwpError!void
```
...
```zig
pub fn process(self: *const PostProcessor, result: ExtractedDocument, config: ExtractionConfig) HwpError!void
```
...
```zig
pub fn renderResult(self: *const Renderer, result: ExtractedDocument) HwpError![:0]const u8
```
...
```zig
pub fn rerank(self: *const RerankerBackend, query: [:0]const u8, documents: []const [:0]const u8) HwpError![]const f32
```
...
```zig
pub fn validate(self: *const Validator, result: ExtractedDocument, config: ExtractionConfig) HwpError!void
```
