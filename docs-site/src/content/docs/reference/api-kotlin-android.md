...
<!-- alef:hash:212afb8aeb99cc219074c8cf40a710e23d1cef0a06abdb0b7661075ce9c69951 -->
...
```kotlin
fun takeEngineRenderWarnings(): List<ProcessingWarning>
```

**Example:**

```kotlin
val result = takeEngineRenderWarnings()
```
