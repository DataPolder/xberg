...
<!-- alef:hash:fabb341537ae317900bb809289ffefb57ddbd25899e1cbf3681f8d65db6a8e9e -->
...
```dart
List<ProcessingWarning> takeEngineRenderWarnings()
```

**Example:**

```dart
final result = takeEngineRenderWarnings();
```
