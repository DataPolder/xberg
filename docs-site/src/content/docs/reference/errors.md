...
<!-- alef:hash:94667b44411b131ef22f63672f0d41547e588c766ad8a9934615c7e70395a3e4 -->
...
| `Cancelled` | Extraction cancelled | The extraction was cancelled. Reachable today only via the REST async-jobs API (`DELETE /jobs/{id}`); no binding exposes an in-process way to cancel an extraction. |
