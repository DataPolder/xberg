...
<!-- alef:hash:3f8beefdcb3534ef001d20de65599de6002a91e7af7e55b3e8841251e96c4668 -->
...
```csharp
public static List<ProcessingWarning> TakeXbergNativePdfRenderWarnings()
```
...
| `KClusters` | `ulong` | `3` | Number of font size clusters to use for hierarchy levels (1-7) Default: 6, which provides H1-H6 heading levels with body text. Larger values create more fine-grained hierarchy levels. |
