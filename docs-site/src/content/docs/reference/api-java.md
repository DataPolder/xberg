...
```java
public static void ensureInitialized() throws HwpError
```
...
**Errors:** Throws `HwpErrorException`.
...
```java
public static void clearEmbeddingBackends() throws HwpError
```
...
```java
public static List<String> listEmbeddingBackends() throws HwpError
```
...
```java
public static List<String> listDocumentExtractors() throws HwpError
```
...
```java
public static void clearDocumentExtractors() throws HwpError
```
...
```java
public static List<String> listOcrBackends() throws HwpError
```
...
```java
public static void clearOcrBackends() throws HwpError
```
...
```java
public static List<String> listPostProcessors() throws HwpError
```
...
```java
public static void clearPostProcessors() throws HwpError
```
...
```java
public static List<String> listRenderers() throws HwpError
```
...
```java
public static void clearRenderers() throws HwpError
```
...
```java
public static void clearRerankerBackends() throws HwpError
```
...
```java
public static List<String> listRerankerBackends() throws HwpError
```
...
```java
public static void clearTokenizerBackends() throws HwpError
```
...
```java
public static List<String> listTokenizerBackends() throws HwpError
```
...
```java
public static List<String> listValidators() throws HwpError
```
...
```java
public static void clearValidators() throws HwpError
```
...
```java
public static void classifyChunks(ExtractedDocument result, ChunkClassificationConfig config) throws HwpError
```
...
```java
public static List<SparseEmbedding> embedSparseAsync(List<String> texts, SparseEmbeddingConfig config) throws HwpError
```
...
```java
public static List<MultiVectorEmbedding> embedMultiVectorAsync(List<String> texts, LateInteractionConfig config, boolean isQuery) throws HwpError
```
...
```java
public static List<SparseEmbedding> embedSparseAsync(List<String> texts, SparseEmbeddingConfig config) throws PdfError
```
...
```java
public static List<MultiVectorEmbedding> embedMultiVectorAsync(List<String> texts, LateInteractionConfig config, boolean isQuery) throws PdfError
```
...
| `breadcrumbTarget` | `BreadcrumbTarget` | `BreadcrumbTarget.CONTENT` | Where the heading-path breadcrumb is written when `prepend_heading_context` is `true`. See `BreadcrumbTarget` for the dense-vs-lexical retrieval trade-off. Has no effect when `prepend_heading_context` is `false`. Default: `Content` — preserves the pre-existing behaviour of prepending the breadcrumb into chunk `content`. |
...
```java
public ExtractedDocument extract(ExtractInput input, ExtractionConfig config) throws HwpError
```
...
```java
public List<List<Float>> embed(List<String> texts) throws HwpError
```
...
```java
public void validate() throws HwpError
```
...
```java
public ExtractedDocument processImage(byte[] imageBytes, OcrConfig config) throws HwpError
```
...
```java
public ExtractedDocument processImageFile(String path, OcrConfig config) throws HwpError
```
...
```java
public ExtractedDocument processDocument(String path, OcrConfig config) throws HwpError
```
...
```java
public void initialize() throws HwpError
```
...
```java
public void shutdown() throws HwpError
```
...
```java
public void process(ExtractedDocument result, ExtractionConfig config) throws HwpError
```
...
```java
public String renderResult(ExtractedDocument result) throws HwpError
```
...
```java
public List<Float> rerank(String query, List<String> documents) throws HwpError
```
...
```java
public void validate(ExtractedDocument result, ExtractionConfig config) throws HwpError
```
