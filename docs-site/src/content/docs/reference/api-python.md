...
<!-- alef:hash:5475ac0c7a4b47636e18233c9d176f18e529104794bd1aea3eea14b81d5c3fe1 -->
...
```python
result = take_engine_render_warnings()
```
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `version` | `str` | Yes | `"pp-ocrv6"` (default) or `"pp-ocrv5"`. Under `"pp-ocrv6"`, `model_tier` selects among `"medium"`/`"small"`/`"tiny"`. |
