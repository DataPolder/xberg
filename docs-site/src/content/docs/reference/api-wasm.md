...
<!-- alef:hash:754c863b229d90d4c36e0b3d0cfca8a45b8b3542b32daa10cecfa752959fc861 -->
...
```typescript
function takeXbergNativePdfRenderWarnings(): Array<ProcessingWarning>
```

**Example:**

```typescript
const result = takeXbergNativePdfRenderWarnings();
```
