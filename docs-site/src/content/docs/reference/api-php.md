...
<!-- alef:hash:ed7a9190bf985cdf3ba5e0db18334ad30e75770d3da47c4e699b68fee4de474c -->
...
```php
public static function takeXbergNativePdfRenderWarnings(): array<ProcessingWarning>
```
