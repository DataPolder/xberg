...
![Xberg features overview -- 98+ input formats flow through extraction, OCR, and processing to produce text, tables, chunks, and metadata](../../assets/feature-overview.png)

---

## Format Support

98+ file formats handled by native Rust extractors — no LibreOffice or other external tools required.
