...
101 file formats (115 file extensions) handled by native Rust extractors — no LibreOffice or other external tools required.
...
**Rust crate feature flag (for custom builds):** `candle-paddleocr-vl-15`
