...
<!-- alef:hash:648ce833072d42f1378b2df6cee632190f40324c9c82f4f61f33eb17f82ed5e9 -->
...
int main(void) {
    ...
    FILE *inputs_file_0 = fopen("pdf/fake_memo.pdf", "rb");
    ...
    XBERGAlefHandle inputs_handle = xberg_extract_input_from_json(inputs_json_0);
    free(inputs_json_0);
