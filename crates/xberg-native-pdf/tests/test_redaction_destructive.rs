//! Destructive-redaction integration test — the [BLOCK] security
...
fn destructive_redaction_removes_secret_text_and_bytes() {
    ...
    let raw_opts = xberg_native_pdf::editor::SaveOptions {
        compress: false,
        ..xberg_native_pdf::editor::SaveOptions::full_rewrite()
    };
