...
mod annotation_tests {
    ...
    fn test_link_with_quad_points() {
        let quad = vec![72.0, 720.0, 172.0, 720.0, 172.0, 732.0, 72.0, 732.0];
...
mod integration_tests {
    ...
    fn test_complete_document_structure() {
        ...
        annotations.uri(Rect::new(72.0, 720.0, 200.0, 12.0), "https://docs.rs/native_pdf");
        ...
        assert!(template.get_header(1).is_some());
        assert!(template.get_footer(1).is_none());
