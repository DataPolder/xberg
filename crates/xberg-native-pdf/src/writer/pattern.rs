...
//!
//! ```ignore
//! use xberg_native_pdf::writer::pattern::{TilingPatternBuilder, PatternPaintType};
...
impl ShadingPatternBuilder {
    ...
    pub fn build(&self) -> Object {
        ...
        // We'll put a placeholder that the caller should replace ~keep
...
impl PatternPresets {
    ...
    pub fn dots(spacing: f32, radius: f32, color: Color) -> Vec<u8> {
        // Approximate circle with Bézier curves ~keep
