...
//!
//! ```ignore
//! use xberg_native_pdf::writer::form_fields::{PushButtonWidget, FormAction};
...
impl PushButtonWidget {
    ...
    pub fn new(name: impl Into<String>, rect: Rect) -> Self {
        Self {
            ...
            caption: String::new(),
            action: None,
            flags: ButtonFieldFlags::PUSHBUTTON,
            font_name: "Helv".to_string(),
            font_size: 12.0,
            text_color: (0.0, 0.0, 0.0),
            border_color: Some((0.0, 0.0, 0.0)),
            background_color: Some((0.85, 0.85, 0.85)),
            border_width: 1.0,
            tooltip: None,
        }
    }
...
impl FormFieldWidget for PushButtonWidget {
    ...
    fn build_widget_dict(&self, page_ref: ObjectRef) -> HashMap<String, Object> {
        ...
        if self.border_width > 0.0 {
            ...
            bs.insert("S".to_string(), Object::Name("B".to_string())); // Beveled for buttons ~keep
