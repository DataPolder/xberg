...
//!
//! ```ignore
//! use xberg_native_pdf::writer::form_fields::CheckboxWidget;
...
impl FormFieldWidget for CheckboxWidget {
    ...
    fn build_field_dict(&self) -> HashMap<String, Object> {
        ...
        // Field type - Button (no Radio or Pushbutton flags = checkbox) ~keep
    ...
    fn build_widget_dict(&self, page_ref: ObjectRef) -> HashMap<String, Object> {
        ...
        if self.border_width > 0.0 {
            ...
            bs.insert("S".to_string(), Object::Name("S".to_string())); // Solid ~keep
        ...
        // Caption character for checkbox (4 = checkmark in ZapfDingbats) ~keep
