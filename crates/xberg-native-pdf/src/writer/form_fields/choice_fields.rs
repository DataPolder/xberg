...
//!
//! ```ignore
//! use xberg_native_pdf::writer::form_fields::{ComboBoxWidget, ListBoxWidget};
...
mod tests {
    ...
    fn test_choice_option_pairs() {
        ...
        if let Some(Object::Array(opts)) = dict.get("Opt") {
            // Each option should be an array [export, display] ~keep
