...
//!
//! ```ignore
//! use xberg_native_pdf::writer::form_fields::RadioButtonGroup;
...
impl RadioButtonWidget {
    ...
    pub fn build_widget_dict(
        ...
        // Caption character for radio (l = bullet in ZapfDingbats) ~keep
