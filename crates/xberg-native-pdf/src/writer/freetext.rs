...
//!
//! ```ignore
//! use xberg_native_pdf::writer::FreeTextAnnotation;
...
impl FreeTextAnnotation {
    ...
    pub fn new(rect: Rect, contents: impl Into<String>) -> Self {
        Self {
            ...
            default_style: None,
            color: None,
            interior_color: Some(AnnotationColor::white()),
            opacity: None,
            border_style: None,
            border_width: None,
    ...
    pub fn with_text_color(mut self, r: f32, g: f32, b: f32) -> Self {
        ...
        self = self.with_font("Helvetica", 12.0);
        self
    }
    ...
    pub fn build(&self, _page_refs: &[ObjectRef]) -> HashMap<String, Object> {
        ...
        // Line ending (LE entry) for callout ~keep
        ...
        // Color (C entry) - border/text color ~keep
        if let Some(ref color) = self.color
            && let Some(color_array) = color.to_array()
            && !color_array.is_empty()
        {
            dict.insert(
                "C".to_string(),
                Object::Array(
        ...
        // Interior color (IC entry) - background fill ~keep
        ...
        // Rectangle differences (RD entry) ~keep
...
mod tests {
    ...
    fn test_freetext_build() {
        ...
        let ft = FreeTextAnnotation::new(rect, "Test content")
            ...
            .with_background_color(1.0, 1.0, 0.8)
