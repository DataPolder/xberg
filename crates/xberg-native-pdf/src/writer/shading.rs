...
//!
//! ```ignore
//! use xberg_native_pdf::writer::shading::{LinearGradientBuilder, GradientStop};
...
impl LinearGradientBuilder {
    ...
    pub fn build(&self) -> (Object, Option<Object>) {
        ...
        // ShadingType 2 = Axial (linear gradient) ~keep
    ...
    fn build_function(&self) -> (Object, Option<Object>) {
        // Sort stops by position ~keep
        let mut stops = self.stops.clone();
        stops.sort_by(|a, b| crate::utils::safe_float_cmp(a.position, b.position));
        ...
        // Simple two-color gradient uses Type 2 (exponential interpolation) ~keep
        ...
        // Multi-stop gradient uses Type 3 (stitching function) ~keep
    ...
    fn build_type2_function(&self, c0: &Color, c1: &Color) -> Object {
        ...
        // FunctionType 2 = Exponential interpolation ~keep
        ...
        // N = exponent (1.0 for linear) ~keep
...
impl GradientPresets {
    ...
    pub fn red_to_blue() -> LinearGradientBuilder {
        LinearGradientBuilder::two_color(Color::new(1.0, 0.0, 0.0), Color::new(0.0, 0.0, 1.0))
    }
    ...
    pub fn rainbow() -> LinearGradientBuilder {
        LinearGradientBuilder::new()
            ...
            .add_stop(0.17, Color::new(1.0, 0.5, 0.0))
            .add_stop(0.33, Color::new(1.0, 1.0, 0.0))
            .add_stop(0.5, Color::new(0.0, 1.0, 0.0))
            .add_stop(0.67, Color::new(0.0, 0.0, 1.0))
            .add_stop(0.83, Color::new(0.29, 0.0, 0.51))
            .add_stop(1.0, Color::new(0.56, 0.0, 1.0))
    }
