...
//!
//! ```ignore
//! use xberg_native_pdf::writer::{CaretAnnotation, RedactAnnotation};
//!
...
impl CaretAnnotation {
    ...
    pub fn new(rect: Rect) -> Self {
        Self {
            ...
            author: None,
            subject: None,
            color: Some(AnnotationColor::Rgb(0.0, 0.0, 1.0)),
...
impl FileAttachmentAnnotation {
    ...
    pub fn build(&self, _page_refs: &[ObjectRef]) -> HashMap<String, Object> {
        ...
        // File Specification (FS) - simplified version ~keep
