...
//!
//! ```ignore
//! use xberg_native_pdf::writer::{PageTemplate, Artifact, Placeholder};
//!
...
impl Artifact {
    ...
    pub fn new() -> Self {
        Self {
            offset: 36.0, // Half inch from edge ~keep
            ..Default::default()
        }
    }
...
impl PageTemplate {
    ...
    pub fn new() -> Self {
        Self {
            margin_left: 72.0,  // 1 inch ~keep
            margin_right: 72.0, // 1 inch ~keep
            ..Default::default()
        }
    }
