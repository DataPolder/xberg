...
pub use auto::{
    ...
    ImageCodecClass, PageClassification, PageExtraction, PageKind, PageSignals, ProducerPrior,
    Quad, ReasonCode, Region, RegionKind, TableData,
};
...
pub use images::{
    ColorSpace, ImageData, PdfImage, PixelFormat, expand_inline_image_dict,
