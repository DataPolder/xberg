...
///
/// ```ignore
/// use xberg_native_pdf::xfa::{XfaConverter, ConvertedField, add_converted_field};
/// use xberg_native_pdf::writer::PdfWriter;
///
...
///
/// ```ignore
/// use xberg_native_pdf::xfa::{XfaConverter, add_converted_page};
/// use xberg_native_pdf::writer::PdfWriter;
///
...
pub fn add_converted_page(page: &mut PageBuilder, converted_page: &ConvertedPage) {
    ...
    for (rect, caption) in &converted_page.captions {
        page.add_text(caption, rect.x, rect.y, "Helvetica", 12.0);
    }
}
...
/// use xberg_native_pdf::xfa::{convert_xfa_document, XfaConversionOptions};
///
