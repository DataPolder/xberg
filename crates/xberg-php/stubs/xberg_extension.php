...
// alef:hash:09f5e1a7d0a80e72d360e6999d3082fbd9b065c2694bbb26a1b4177a05a552fb
...
final class ChunkingConfig
{
    public function __construct(
         ...
         * @var string
         */
        public readonly string $breadcrumbTarget,
    ...
    { throw new \RuntimeException('Not implemented — provided by the native extension.'); }
    public function getBreadcrumbTarget(): string
    { throw new \RuntimeException('Not implemented — provided by the native extension.'); }
...
final class NodeContent
{
    ...
    public readonly ?string $content;
    /** @var ?array<array<string>> Key-value pairs extracted from the metadata block. */
...
final class OcrBoundingGeometry
{
    ...
    public readonly ?int $height;
    /** @var ?string Four corner points as `[[x, y], ...]` in clockwise order */
...
final class RerankerModelType
{
    ...
    /** @param array<string> $additionalFiles */
    public static function custom(string $modelId, ?string $modelFile = null, ?array $additionalFiles = null, ?int $maxLength = null, ?string $head = null): RerankerModelType { throw new \RuntimeException('Not implemented — provided by the native extension.'); }
...
class XbergApi
{
     ...
     * @return array<\Xberg\ProcessingWarning>
     */
    public static function takeXbergNativePdfRenderWarnings(): array { throw new \RuntimeException('Not implemented.'); }
