...
use ttf_parser::{GlyphId, RgbaColor, cpal};
...
fn basic() {
    ...
    let colr_data = convert(&[
        ...
        UInt16(2),
        UInt16(2),
        UInt16(2), // base glyph 0 (id 2)
        UInt16(3),
        UInt16(0),
        UInt16(3), // base glyph 1 (id 3)
        UInt16(7),
        UInt16(1),
        UInt16(1), // base glyph 2 (id 7)
        UInt16(10),
        UInt16(2), // layer 0
        UInt16(11),
        UInt16(1), // layer 1
    ...
    let paint = |id| {
        ...
        colr.paint(GlyphId(id), 0, &mut painter, &[], RgbaColor::new(0, 0, 0, 255))
            .map(|_| painter.0)
    };
    ...
    assert_eq!(
        paint(7).unwrap(),
        vec![Command::OutlineGlyph(GlyphId(11)), Command::Paint(b.clone()),]
    );
}
...
impl<'a> Painter<'a> for VecPainter {
    ...
    fn paint(&mut self, paint: Paint<'a>) {
        let custom_paint = match paint {
            ...
            Paint::LinearGradient(lg) => CustomPaint::LinearGradient(
                lg.x0,
                lg.y0,
                lg.x1,
                lg.y1,
                ...
                lg.extend,
                lg.stops(0, &[])
                    .map(|stop| CustomStop(stop.stop_offset, stop.color))
                    .collect(),
            ),
            Paint::RadialGradient(rg) => CustomPaint::RadialGradient(
                rg.x0,
                rg.y0,
                rg.r0,
                rg.r1,
            ...
            Paint::SweepGradient(sg) => CustomPaint::SweepGradient(
                sg.center_x,
                sg.center_y,
                sg.start_angle,
                sg.end_angle,
...
mod colr1_static {
    ...
    fn scale() {
        ...
        assert!(
            vec_painter
                .0
                .contains(&Transform(ttf_parser::Transform::new_scale(0.5, 1.5)))
        )
    }
    ...
    fn rotate() {
        ...
        assert!(
            vec_painter
                .0
                .contains(&Transform(ttf_parser::Transform::new_rotate(0.055541992)))
        )
    }
    ...
    fn skew() {
        ...
        assert!(
            vec_painter
                .0
                .contains(&Transform(ttf_parser::Transform::new_skew(0.13891602, 0.0)))
        );
    }
    ...
    fn translate() {
        ...
        assert!(
            vec_painter
                .0
                .contains(&Transform(ttf_parser::Transform::new_translate(0.0, 100.0)))
        );
    }
...
mod colr1_variable {
    ...
    fn sweep_gradient() {
        ...
        let mut vec_painter = VecPainter(vec![]);
        face.paint_color_glyph(GlyphId(13), 0, RgbaColor::new(0, 0, 0, 255), &mut vec_painter);
        assert!(vec_painter.0.contains(&Paint(SweepGradient(
            500.0,
            600.0,
            -0.416687,
            0.9888916,
    ...
    fn scale_around_center() {
        ...
        assert!(
            vec_painter
                .0
                .contains(&Transform(ttf_parser::Transform::new_scale(1.599942, 0.60009766)))
        )
    }
    ...
    fn rotate() {
        ...
        assert!(
            vec_painter
                .0
                .contains(&Transform(ttf_parser::Transform::new_rotate(0.87341005)))
        )
    }
    ...
    fn rotate_around_center() {
        ...
        assert!(
            vec_painter
                .0
                .contains(&Transform(ttf_parser::Transform::new_rotate(0.9336252)))
        )
    }
    ...
    fn skew() {
        ...
        assert!(
            vec_painter
                .0
                .contains(&Transform(ttf_parser::Transform::new_skew(0.3944702, 0.0)))
        );
    }
    ...
    fn translate() {
        ...
        assert!(
            vec_painter
                .0
                .contains(&Transform(ttf_parser::Transform::new_translate(99.975586, 100.0)))
        );
    }
}
