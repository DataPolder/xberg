...
use ttf_parser::{CFFError, GlyphId, Rect, cff};
...
test_cs!(
    vmove_to,
    &[CFFInt(10), UInt8(operator::VERTICAL_MOVE_TO), UInt8(operator::ENDCHAR),],
    "M 0 10 Z ",
    rect(0, 10, 0, 10)
);
...
test_cs_err!(
    move_to_with_not_enough_coords,
    &[CFFInt(10), UInt8(operator::MOVE_TO), UInt8(operator::ENDCHAR),],
    CFFError::InvalidArgumentsStackLength
);
...
test_cs_err!(
    hmove_to_with_not_enough_coords,
    &[UInt8(operator::HORIZONTAL_MOVE_TO), UInt8(operator::ENDCHAR),],
    CFFError::InvalidArgumentsStackLength
);
...
test_cs_err!(
    vmove_to_with_not_enough_coords,
...
test_cs_err!(
    hh_curve_to_with_not_enough_coords,
    &[
        CFFInt(10),
        CFFInt(20),
        UInt8(operator::MOVE_TO),
...
test_cs_err!(
    vv_curve_to_with_not_enough_coords,
    &[
        CFFInt(10),
        CFFInt(20),
        UInt8(operator::MOVE_TO),
...
test_cs_err!(
    ...
    &[CFFInt(0), CFFInt(0), CFFInt(0), CFFInt(0), UInt8(operator::ENDCHAR),],
