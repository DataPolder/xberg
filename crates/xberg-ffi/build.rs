...
// alef:hash:b9c1d892820918bba63106aa6e23fb0f9284e0152e07e2c656647bbd98937605
...
fn main() {
    ...
    // `#if defined(XBERG_FEATURE_X)` (its `[defines]` table), and it does so from
    ...
    {
        let header_path = "include/xberg.h";
