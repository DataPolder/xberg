...
mod tests {
    ...
    const PROSE_PAGE_WORDS: &[(&str, u32, u32, u32, u32)] = &[
        ("district", 260, 134, 40, 75), ("zonn", 373, 134, 41, 60), ("zoning", 403, 134, 39, 70),
        ("comprehensive", 748, 134, 40, 156), ("located", 460, 136, 41, 73), ("hereby", 547, 136, 42, 67),
        ("and", 839, 136, 31, 38), ("SOUTHEAST", 1296, 136, 41, 154), ("ordinance:", 175, 137, 33, 109),
        ("Texas.", 347, 137, 34, 67), ("Development", 1150, 137, 45, 137), ("Parkway", 1181, 137, 40, 86),
        ("AN", 1412, 137, 44, 39), ("requested", 865, 138, 33, 93), ("public", 953, 138, 33, 66),
        ("City", 1065, 138, 41, 41), ("land", 1212, 138, 39, 44), ("PLAN", 1326, 138, 41, 65),
        ("A", 430, 141, 41, 12), ("THEREFORE:", 725, 141, 33, 152), ("PROVIDING", 1385, 142, 40, 143),
        ("DISTRICT", 1357, 144, 39, 120), ("attached", 430, 161, 41, 81), ("ORDINANCE", 1411, 188, 45, 150),
        ("located", 1212, 190, 39, 70), ("Council,", 1065, 194, 41, 82), ("dsrt", 373, 209, 41, 74),
        ("hearing", 953, 209, 33, 72), ("Se", 285, 210, 44, 26), ("declared", 546, 211, 42, 87),
        ("Section1.That", 576, 211, 40, 173), ("classification.", 257, 212, 42, 140), ("at", 460, 212, 41, 19),
        ("Section", 489, 212, 41, 80), ("e,", 977, 214, 44, 39), ("Section", 201, 216, 40, 72),
        ("district", 403, 219, 39, 70), ("WHEREAS,", 1096, 219, 41, 122), ("WHEREAS,", 779, 220, 41, 121),
        ("WHEREAS,", 1239, 221, 41, 123), ("WHEREAS,", 1007, 222, 45, 122), ("WHEREAS,", 891, 225, 45, 124),
        ("FOR", 1326, 228, 41, 52), ("and", 1181, 238, 40, 32), ("the", 460, 240, 41, 25),
        ("zoning", 865, 242, 33, 66), ("hereto", 430, 257, 41, 60), ("n", 977, 258, 44, 17),
        ("on", 285, 268, 44, 19), ("southeast", 460, 274, 41, 96), ("within", 1211, 274, 40, 64),
        ("TO", 1357, 274, 39, 29), ("recommending", 1064, 277, 42, 152), ("classifcaon", 372, 284, 42, 135),
        ("(PD)", 1150, 284, 44, 48), ("Creek", 1180, 284, 41, 60), ("h", 977, 287, 44, 18),
        ("on", 953, 292, 33, 22), ("4.", 201, 296, 40, 18), ("3.That", 285, 298, 44, 78),
        ("classification", 402, 298, 40, 129), ("APPROXIMATELY", 1325, 298, 42, 223), ("true", 545, 300, 42, 39),
        ("CORNER", 1296, 300, 41, 106), ("2.", 489, 301, 41, 19), ("FOR", 1384, 302, 41, 50),
        ("plan", 748, 304, 40, 47), ("PLANNED", 1356, 313, 40, 120), ("change", 865, 319, 33, 66),
        ("such", 953, 320, 33, 44), ("and", 430, 325, 41, 32), ("That", 201, 329, 40, 45),
        ("That", 489, 335, 41, 46), ("District", 1149, 335, 45, 78), ("me", 976, 339, 44, 25),
        ("the", 1211, 339, 39, 31), ("the", 1007, 347, 44, 34), ("and", 545, 348, 41, 39),
        ("the", 1096, 349, 41, 33), ("the", 778, 350, 42, 33), ("OF", 1411, 350, 44, 32),
        ("the", 1239, 351, 41, 27), ("the", 891, 358, 45, 36), ("Bend", 1180, 359, 41, 45),
        ("and", 747, 365, 40, 33), ("incorporated", 429, 366, 42, 128), ("corner", 460, 372, 41, 67),
        ("requested", 953, 375, 33, 94), ("A", 1384, 376, 40, 16), ("the", 284, 379, 45, 33),
        ("BE", 662, 379, 41, 31), ("the", 200, 382, 41, 32), ("nd", 976, 383, 44, 25),
        ("City", 1211, 385, 39, 37), ("current", 1238, 386, 42, 74), ("THE", 1411, 387, 44, 54),
        ("OF", 637, 389, 33, 32), ("the", 489, 390, 41, 33), ("City", 1095, 390, 41, 40),
        ("City", 1007, 391, 44, 42), ("the", 576, 393, 40, 24), ("correct.", 544, 395, 42, 80),
        ("and", 865, 396, 33, 33), ("City", 778, 398, 41, 39), ("City", 891, 403, 44, 42),
        ("now", 747, 412, 40, 40), ("IT", 662, 413, 41, 31), ("OF", 1296, 416, 41, 31),
        ("CHANGE", 1384, 416, 40, 103), ("Drive,", 1180, 419, 40, 66), ("m", 976, 420, 44, 17),
        ("following", 200, 422, 40, 99), ("City's", 284, 423, 44, 48), ("Final", 1149, 423, 44, 48),
        ("THE", 637, 427, 33, 49), ("zoning", 489, 431, 41, 67), ("of", 1211, 431, 39, 24),
        ("facts", 575, 433, 41, 46), ("nder", 372, 434, 41, 47), ("approval", 1064, 437, 41, 88),
        ("Planning", 1095, 438, 41, 88), ("the", 865, 440, 33, 27), ("of", 459, 441, 41, 18),
        ("Planning", 1006, 442, 45, 86), ("to", 402, 443, 40, 18), ("DEVELOPMENT", 1355, 443, 40, 198),
        ("CITY", 1411, 446, 44, 61), ("ORDAINED", 661, 447, 42, 133), ("Council", 777, 453, 42, 80),
        ("Planning", 890, 454, 45, 88), ("LAKE", 1295, 457, 41, 65), ("Sugar", 1211, 463, 39, 57),
        ("e", 976, 464, 44, 17), ("property", 1238, 468, 41, 81), ("Lake", 459, 469, 41, 45),
        ("deems", 747, 473, 40, 67), ("Planned", 402, 475, 39, 78), ("same", 865, 478, 33, 49),
        ("zoning", 953, 480, 33, 60), ("official", 284, 482, 44, 70), ("the", 372, 482, 41, 33),
        ("Development", 1147, 482, 45, 129), ("and", 575, 488, 41, 31), ("CITY", 637, 488, 33, 60),
        ("be", 1180, 494, 40, 18), ("herein", 429, 502, 41, 60), ("ORDINANCE", 1474, 502, 32, 148),
        ("district", 488, 506, 42, 74), ("n", 975, 508, 45, 18), ("COUNCIL", 1410, 519, 45, 113),
        ("rezoned", 1179, 521, 41, 80), ("comprehensive", 371, 523, 41, 149), ("Pointe", 459, 524, 41, 60),
        ("recitations", 575, 528, 40, 108), ("Land", 1210, 528, 39, 51), ("POINTE", 1295, 532, 41, 93),
        ("0.7906", 1325, 532, 41, 79), ("is", 865, 533, 33, 22), ("of", 1064, 533, 40, 19),
        ("and", 1094, 534, 42, 40), ("Exhibits", 199, 536, 41, 85), ("ae", 975, 537, 44, 47),
        ("and", 1006, 538, 44, 34), ("finds", 777, 542, 41, 46), ("OF", 1383, 543, 40, 29),
        ("it", 747, 547, 39, 20), ("change;", 953, 551, 33, 78), ("owner", 1237, 557, 42, 61),
        ("OF", 637, 559, 33, 33), ("and", 890, 559, 44, 36), ("herein", 865, 560, 33, 61),
        ("the", 1063, 560, 41, 32), ("zoning", 283, 563, 45, 63), ("Development", 401, 569, 40, 131),
        ("by", 429, 571, 41, 25), ("appropriate", 746, 580, 40, 114), ("classification", 488, 582, 41, 136),
        ("Zoning", 1005, 582, 45, 71), ("Zoning", 1094, 582, 41, 67), ("(the", 1210, 587, 39, 37),
        ("BY", 661, 591, 41, 30), ("Parkway", 459, 592, 41, 87), ("rezoning", 1063, 594, 41, 87),
        ("ZONING", 1383, 596, 40, 96), ("SUGAR", 637, 598, 33, 82), ("that", 777, 604, 41, 39),
        ("Zoning", 889, 604, 45, 73), ("reference,", 429, 605, 41, 100), ("from", 1179, 616, 41, 46),
        ("Plan;", 1147, 621, 44, 48), ("has", 1237, 625, 41, 34), ("ACRES", 1325, 627, 40, 85),
        ("are", 199, 629, 40, 31), ("THE", 661, 632, 41, 51), ("incorporated", 865, 632, 33, 126),
        ("c", 975, 633, 44, 18), ("and", 953, 634, 33, 39), ("PARKWAY", 1295, 635, 41, 126),
        ("map", 283, 636, 44, 41), ("\"City\"),", 1210, 639, 39, 76), ("set", 574, 644, 41, 33),
        ("OF", 1410, 644, 44, 33), ("(PD)", 1355, 645, 39, 55), ("the", 776, 652, 42, 32),
        ("NO.", 1474, 661, 32, 47), ("Commission", 1004, 663, 45, 123), ("Commission", 1093, 665, 42, 121),
        ("requested", 1236, 667, 42, 95), ("attached", 198, 669, 41, 85), ("que", 974, 677, 45, 62),
        ("Business", 1178, 677, 41, 88), ("zoning", 370, 679, 42, 68), ("forth", 574, 679, 41, 53),
        ("and", 1147, 679, 44, 34), ("be", 283, 680, 44, 27), ("THE", 1409, 681, 45, 54),
        ("Commission", 888, 686, 45, 127), ("and", 459, 688, 40, 31), ("request;", 1063, 689, 40, 87),
        ("LAND,", 637, 691, 33, 82), ("CITY", 660, 693, 42, 58), ("zoning", 776, 693, 41, 66),
        ("is", 429, 707, 41, 26), ("to", 746, 707, 40, 20), ("FROM", 1382, 709, 41, 70),
        ("2197", 1474, 709, 32, 53), ("amended", 282, 710, 45, 92), ("DISTRICT", 1354, 710, 40, 114),
        ("(PD)", 401, 715, 40, 46), ("at", 1209, 723, 40, 18), ("of", 488, 726, 41, 19),
        ("Creek", 459, 729, 40, 52), ("OF", 1325, 730, 40, 30), ("changed", 428, 734, 42, 87),
        ("in", 574, 740, 41, 19), ("CITY", 1409, 740, 44, 62), ("make", 746, 747, 39, 52),
        ("ordiance", 370, 748, 41, 101), ("the", 1209, 750, 39, 30), ("by", 974, 751, 44, 31),
        ("approximately", 487, 753, 42, 143), ("COUNCIL", 660, 761, 41, 113), ("and", 865, 764, 33, 38),
        ("the", 574, 768, 41, 32), ("hereto", 198, 769, 40, 58), ("request", 775, 769, 42, 80),
        ("that", 1236, 769, 41, 41), ("AND", 1294, 771, 42, 51), ("TEXAS:", 637, 774, 33, 93),
        ("District", 401, 775, 40, 74), ("LAND", 1324, 776, 41, 72), ("and", 1063, 777, 40, 39),
        ("Office", 1178, 780, 41, 61), ("l", 974, 781, 44, 17), ("Southeast", 1209, 789, 39, 96),
        ("forwarded", 1093, 795, 41, 101), ("Bend", 458, 796, 41, 46), ("and", 1004, 796, 44, 34),
        ("to", 282, 805, 44, 19), ("preamble", 573, 809, 42, 88), ("approximately", 1235, 810, 42, 150),
        ("BUSINESS", 1381, 810, 41, 116), ("such", 746, 813, 39, 46), ("made", 865, 813, 33, 49),
        ("OF", 1409, 814, 44, 32), ("recommended", 887, 823, 45, 142), ("from", 428, 830, 41, 39),
        ("an", 974, 832, 44, 25), ("CREEK", 1294, 833, 41, 85), ("FINAL", 1354, 833, 39, 75),
        ("reflect", 282, 835, 44, 63), ("the", 1003, 840, 45, 34), ("and", 198, 842, 40, 32),
        ("(B-O)", 1178, 850, 41, 60), ("SUGAR", 1408, 850, 45, 91), ("Drive,", 458, 851, 41, 59),
        ("of", 370, 857, 41, 19), ("complies", 775, 858, 41, 87), ("Final", 400, 863, 40, 52),
        ("a", 865, 868, 33, 11), ("LOCATED", 1324, 871, 41, 118), ("zoning", 745, 872, 40, 72),
        ("the", 370, 877, 41, 33), ("City", 1003, 884, 44, 42), ("Business", 428, 885, 41, 93),
        ("incorporated", 197, 888, 41, 125), ("part", 865, 890, 33, 38), ("corner", 1208, 893, 40, 63),
        ("pable", 973, 898, 45, 84), ("this", 281, 901, 45, 41), ("0.7906", 487, 904, 41, 67),
        ("its", 1093, 905, 41, 25), ("of", 573, 906, 41, 26), ("Cty", 369, 918, 42, 40),
        ("described", 458, 918, 40, 93), ("District", 1177, 919, 41, 74), ("Development", 400, 924, 40, 134),
        ("DEVELOPMENT", 1353, 924, 40, 193), ("BEND", 1294, 928, 41, 65), ("of", 865, 934, 33, 22),
        ("Council", 1002, 935, 45, 79), ("final", 1092, 939, 42, 46), ("the", 573, 941, 41, 26),
        ("change", 281, 945, 44, 71), ("LAND,", 1408, 946, 44, 84), ("OFFICE", 1381, 950, 40, 89),
        ("change;", 745, 957, 39, 80), ("with", 774, 960, 42, 46), ("this", 865, 961, 33, 38),
        ("0.7906", 1235, 961, 41, 68), ("of", 1208, 964, 39, 25), ("of", 369, 966, 41, 20),
        ("granting", 886, 975, 45, 81), ("ordinance", 573, 976, 41, 102), ("rezoneord", 78, 982, 33, 56),
        ("Office", 428, 987, 41, 59), ("acres", 487, 987, 41, 46), ("Sugar", 369, 993, 41, 54),
        ("3/16/20", 69, 994, 23, 44), ("r", 973, 994, 44, 17), ("report", 1092, 994, 41, 60),
        ("Lake", 1208, 997, 39, 44), ("to", 1177, 1002, 41, 18), ("DRIVE.", 1294, 1003, 41, 92),
        ("ordinance;", 865, 1005, 33, 110), ("in", 458, 1012, 40, 25), ("AT", 1324, 1012, 40, 31),
        ("the", 774, 1015, 41, 25), ("have", 1002, 1016, 44, 49), ("in", 281, 1019, 44, 19),
        ("into", 197, 1022, 40, 38), ("TEXAS,", 1408, 1034, 44, 89), ("Planned", 1177, 1037, 41, 74),
        ("acres", 1235, 1037, 41, 54), ("of", 487, 1041, 41, 26), ("Exhibit", 458, 1045, 40, 73),
        ("zoning", 281, 1048, 44, 71), ("NOW,", 745, 1049, 39, 73), ("Land,", 369, 1055, 41, 60),
        ("(B-O)", 428, 1055, 41, 60), ("to", 1092, 1055, 41, 26), ("Pointe", 1208, 1055, 39, 64),
        ("City's", 774, 1056, 41, 67), ("(B-O)", 1381, 1056, 40, 63), ("THE", 1324, 1066, 40, 51),
        ("e,", 973, 1067, 44, 39), ("land", 487, 1069, 41, 46), ("Plan", 400, 1073, 40, 40),
        ("such", 886, 1074, 45, 44), ("this", 197, 1075, 40, 38), ("each", 1002, 1075, 44, 42),
        ("are", 573, 1088, 41, 32), ("the", 1092, 1090, 41, 32), ("of", 1235, 1098, 41, 27),
        ("a", 973, 1105, 44, 17),
    ];
    ...
    const DENSE_TABLE_WORDS: &[(&str, u32, u32, u32, u32)] = &[
        ("Nasdaq", 48, 72, 185, 84), ("&", 251, 74, 36, 83), ("AMEX", 305, 75, 159, 84),
        ("Stocks", 44, 152, 52, 32), ("in", 102, 153, 20, 32), ("bold", 128, 153, 37, 33),
        ("rose", 171, 154, 37, 33), ("or", 214, 155, 15, 32), ("fell", 230, 156, 37, 32),
        ("5%", 267, 156, 22, 33), ("or", 295, 157, 21, 32), ("more", 322, 158, 43, 32),
        ("USA", 78, 194, 40, 32), ("Track", 136, 188, 44, 34), ("your", 192, 189, 39, 34),
        ("investments", 237, 190, 111, 35), ("with", 360, 193, 38, 33), ("our", 404, 194, 26, 33),
        ("continuously", 442, 195, 113, 34), ("TODAY", 48, 218, 73, 29), ("updated", 135, 215, 73, 33),
        ("stocks.", 215, 216, 63, 33), ("Visit", 285, 217, 41, 33), ("us", 333, 218, 14, 32),
        ("on", 360, 218, 14, 33), ("the", 387, 219, 24, 32), ("web", 424, 220, 30, 32),
        ("at", 467, 220, 14, 32), (".com", 70, 235, 51, 30), ("money.usatoday.com", 137, 238, 197, 37),
        ("52-week", 41, 272, 48, 19), ("52-week", 335, 273, 50, 26), ("High", 42, 286, 28, 20),
        ("Low", 96, 287, 26, 20), ("Stock", 137, 287, 33, 20), ("Last", 233, 285, 29, 27),
        ("Change", 267, 287, 41, 28), ("High", 338, 293, 24, 18), ("Low", 388, 293, 30, 19),
        ("Stock", 433, 294, 30, 18), ("Last", 528, 293, 26, 24), ("Change", 562, 294, 41, 24),
        ("45.71", 343, 321, 31, 19), ("32.50", 386, 322, 33, 19), ("Biomet", 429, 319, 51, 25),
        ("36.71", 526, 324, 32, 19), ("-0.42", 569, 321, 38, 25), ("2.76", 348, 335, 26, 19),
        ("1.20", 392, 336, 25, 19), ("Biomira", 428, 334, 61, 25), ("BloScrip", 430, 349, 57, 25),
        ("1.46", 534, 341, 23, 15), ("+0.03", 571, 340, 33, 18), ("9.07", 348, 350, 26, 19),
        ("5.13", 391, 351, 26, 19), ("8.05", 533, 355, 26, 16), ("+0.34", 567, 352, 39, 22),
        ("9.19", 54, 365, 24, 18), ("6.89", 97, 366, 23, 18), ("ABX", 136, 363, 29, 24),
        ("Air", 170, 365, 25, 24), ("n", 197, 366, 9, 23), ("7.52", 234, 365, 27, 23),
        ("-0.10", 272, 366, 38, 24), ("68.88", 342, 365, 29, 18), ("50.65", 385, 366, 29, 18),
        ("212.25", 334, 376, 37, 24), ("131.03", 379, 377, 38, 24), ("Biosite", 431, 367, 47, 18),
        ("50.05", 528, 368, 27, 18), ("BiotechT", 429, 378, 57, 25), ("-4.57", 571, 369, 33, 18),
        ("33.25", 46, 379, 32, 19), ("12.40", 89, 380, 33, 19), ("ACMoore", 137, 380, 60, 21),
        ("13.58", 232, 383, 28, 19), ("-1.57", 272, 384, 36, 19), ("204.66", 518, 382, 37, 19),
        ("BirchMt", 428, 393, 58, 25), ("gn", 489, 395, 16, 23), ("-0.84", 566, 384, 38, 18),
        ("31.38", 48, 394, 30, 18), ("13.51", 92, 395, 27, 18), ("ADA-ES", 135, 395, 62, 21),
        ("20.96", 231, 398, 31, 19), ("+3.16", 275, 399, 33, 18), ("8.50", 347, 394, 24, 18),
        ("1.40", 390, 395, 28, 18), ("ADC", 136, 407, 28, 24), ("Tel", 170, 408, 20, 24),
        ("rs", 193, 409, 16, 23), ("Bickbaud", 428, 407, 68, 25), ("6.52", 530, 398, 26, 19),
        ("-0.45", 569, 398, 35, 19), ("27.14", 48, 409, 30, 18), ("12.88", 89, 409, 31, 19),
        ("23.21", 230, 412, 33, 19), ("+0.13", 272, 413, 36, 19), ("18.21", 341, 408, 32, 19),
        ("10.73", 384, 409, 32, 19), ("17.90", 524, 412, 31, 19), ("+0.70", 568, 412, 35, 19),
        ("30.40", 45, 424, 33, 19), ("16.70", 91, 425, 31, 18), ("ADECP", 134, 422, 53, 25),
        ("27.32", 230, 427, 32, 19), ("+0.73", 272, 428, 36, 19), ("52.73", 341, 425, 31, 16),
        ("13.86", 383, 424, 33, 19), ("BluCoat", 428, 422, 57, 25), ("AFC", 135, 436, 29, 24),
        ("Ent", 169, 438, 25, 23), ("s", 196, 439, 9, 22), ("BlueNile", 427, 436, 63, 25),
        ("41.29", 524, 427, 33, 19), ("+1.30", 567, 428, 33, 18), ("16.45", 46, 438, 32, 19),
        ("10.47", 89, 440, 29, 18), ("15.40", 230, 442, 31, 18), ("-0.14", 275, 443, 33, 18),
        ("44.35", 343, 440, 29, 15), ("24.15", 384, 438, 32, 19), ("BobEvn", 426, 451, 57, 25),
        ("40.30", 526, 443, 28, 15), ("-1.10", 570, 443, 33, 18), ("8.37", 54, 453, 22, 19),
        ("4.50", 95, 454, 25, 19), ("ASE", 136, 454, 25, 21), ("Tst", 172, 454, 18, 21),
        ("7.76", 235, 456, 27, 19), ("+0.40", 272, 457, 35, 19), ("26.45", 340, 453, 33, 19),
        ("19.91", 384, 453, 32, 19), ("22.99", 523, 456, 33, 19), ("19.25", 46, 468, 31, 18),
        ("12.75", 90, 469, 31, 18), ("ASM", 134, 466, 29, 24), ("Intl", 169, 467, 29, 25),
        ("17.65", 229, 473, 32, 15), ("-0.03", 272, 472, 36, 19), ("15.94", 340, 469, 32, 15),
        ("6.12", 390, 470, 23, 15), ("Bodisen", 429, 466, 49, 25), ("n", 486, 469, 7, 23),
        ("Bookham", 429, 480, 60, 25), ("15.45", 524, 471, 31, 19), ("ASML", 134, 481, 40, 24),
        ("HId", 180, 483, 24, 23), ("+0.45", 566, 472, 33, 18), ("20.92", 45, 482, 32, 19),
        ("13.94", 87, 483, 32, 19), ("21.24", 228, 486, 30, 18), ("+0.46", 271, 486, 36, 19),
        ("6.21", 348, 482, 22, 19), ("1.56", 388, 482, 27, 19), ("5.94", 532, 485, 21, 19),
        ("+0.06", 567, 486, 36, 19), ("27.38", 44, 497, 32, 19), ("16.39", 87, 498, 31, 19),
        ("ASV", 134, 496, 23, 24), ("Inc", 164, 497, 24, 24), ("5", 190, 498, 9, 23),
        ("26.76", 228, 501, 30, 18), ("+0.14", 273, 501, 31, 19), ("11.80", 339, 496, 32, 19),
        ("4.99", 391, 499, 21, 16), ("Borland", 428, 497, 54, 21), ("10.47", 86, 509, 36, 23),
        ("BostPrv", 428, 509, 57, 25), ("6.68", 529, 500, 26, 19), ("ATI", 136, 510, 23, 24),
        ("Tech", 167, 511, 27, 24), ("31.90", 339, 510, 31, 19), ("+0.14", 568, 501, 33, 18),
        ("19.82", 44, 511, 32, 19), ("17.89", 227, 516, 32, 17), ("+0.68", 270, 516, 37, 18),
        ("21.10", 384, 512, 30, 18), ("BttmlnT", 428, 524, 55, 25), ("31.18", 522, 515, 35, 18),
        ("ATMI", 133, 525, 40, 24), ("Inc", 175, 526, 24, 24), ("-0.07", 567, 516, 35, 17),
        ("33.62", 44, 526, 32, 19), ("20.53", 87, 527, 32, 19), ("29.95", 228, 530, 31, 19),
        ("+1.29", 272, 531, 33, 18), ("18.62", 339, 527, 31, 16), ("10.01", 382, 528, 30, 16),
        ("BrigExp", 428, 538, 55, 26), ("11.53", 522, 529, 35, 18), ("+0.20", 564, 530, 38, 18),
        ("39.20", 43, 541, 33, 18), ("16.76", 87, 542, 30, 18), ("ATP", 133, 542, 26, 20),
        ("O&G", 166, 542, 29, 20), ("38.40", 228, 545, 30, 18), ("-0.59", 272, 546, 32, 17),
        ("14.68", 338, 542, 32, 15), ("7.10", 388, 543, 23, 15), ("12.10", 522, 544, 30, 18),
        ("AVI", 135, 554, 25, 25), ("Bio", 163, 555, 25, 25), ("BrightHrz", 428, 554, 66, 24),
        ("s", 497, 556, 8, 22), ("-0.23", 567, 545, 35, 17), ("4.24", 49, 556, 26, 19),
        ("1.99", 92, 556, 26, 19), ("3.62", 233, 560, 26, 19), ("-0.02", 269, 560, 36, 19),
        ("46.72", 338, 555, 32, 19), ("26.65", 383, 556, 30, 18), ("38.90", 522, 558, 32, 19),
        ("-0.80", 565, 559, 36, 19), ("20\u{2013}55", 338, 570, 30, 10),
    ];
