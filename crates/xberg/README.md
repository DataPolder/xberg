...
```toml
[dependencies]
xberg = { version = "1.0.12", features = ["pdf", "excel", "ocr"] }
```
...
```toml
xberg = { version = "1.0.12", features = ["full"] }
xberg = { version = "1.0.12", features = ["server"] }
xberg = { version = "1.0.12", features = ["cli"] }
```
...
```toml
[dependencies]
xberg = { version = "1.0.12", features = ["pdf"] }
```
