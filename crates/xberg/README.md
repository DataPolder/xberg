...
```toml
[dependencies]
xberg = { version = "1.0.9", features = ["pdf", "excel", "ocr"] }
```
...
```toml
xberg = { version = "1.0.9", features = ["full"] }
xberg = { version = "1.0.9", features = ["server"] }
xberg = { version = "1.0.9", features = ["cli"] }
```
...
```toml
[dependencies]
xberg = { version = "1.0.9", features = ["pdf"] }
```
