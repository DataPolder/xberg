...
```toml
[dependencies]
xberg = { version = "1.0.8", features = ["pdf", "excel", "ocr"] }
```
...
```toml
xberg = { version = "1.0.8", features = ["full"] }
xberg = { version = "1.0.8", features = ["server"] }
xberg = { version = "1.0.8", features = ["cli"] }
```
...
```toml
[dependencies]
xberg = { version = "1.0.8", features = ["pdf"] }
```
