...
```toml
[dependencies]
xberg = { version = "1.0.11", features = ["pdf", "excel", "ocr"] }
```
...
```toml
xberg = { version = "1.0.11", features = ["full"] }
xberg = { version = "1.0.11", features = ["server"] }
xberg = { version = "1.0.11", features = ["cli"] }
```
...
```toml
[dependencies]
xberg = { version = "1.0.11", features = ["pdf"] }
```
