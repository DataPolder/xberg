...
```toml
[dependencies]
xberg = { version = "1.0.7", features = ["pdf", "excel", "ocr"] }
```
...
```toml
xberg = { version = "1.0.7", features = ["full"] }
xberg = { version = "1.0.7", features = ["server"] }
xberg = { version = "1.0.7", features = ["cli"] }
```
...
```toml
[dependencies]
xberg = { version = "1.0.7", features = ["pdf"] }
```
