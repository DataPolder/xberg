...
```toml
[dependencies]
xberg = { version = "1.0.4", features = ["pdf", "excel", "ocr"] }
```
...
```toml
xberg = { version = "1.0.4", features = ["full"] }
xberg = { version = "1.0.4", features = ["server"] }
xberg = { version = "1.0.4", features = ["cli"] }
```
...
```toml
[dependencies]
xberg = { version = "1.0.4", features = ["pdf"] }
```
