...
```toml
[dependencies]
xberg = { version = "1.0.10", features = ["pdf", "excel", "ocr"] }
```
...
```toml
xberg = { version = "1.0.10", features = ["full"] }
xberg = { version = "1.0.10", features = ["server"] }
xberg = { version = "1.0.10", features = ["cli"] }
```
...
```toml
[dependencies]
xberg = { version = "1.0.10", features = ["pdf"] }
```
