...
public final class OcrBackendBridge implements AutoCloseable {
  ...
  // C vtable: 15 fields (4 plugin methods + 9 trait methods + free_string +
  // free_user_data)
  ...
  private long handleSupportsLanguage(MemorySegment userData,
    ...
    try {
      ...
      System.err.println("[OcrBackendBridge] host 'supports_language' threw; "
                         + "returning default: " + e);
      return 0L;
    }
  }
  ...
  private long handleSupportsTableDetection(MemorySegment userData) {
    try {
      ...
      System.err.println("[OcrBackendBridge] host 'supports_table_detection' "
                         + "threw; returning default: " + e);
      return 0L;
    }
  }
  ...
  private long handleSupportsDocumentProcessing(MemorySegment userData) {
    try {
      ...
      System.err.println(
          "[OcrBackendBridge] host 'supports_document_processing' threw; "
          + "returning default: " + e);
      return 0L;
    }
  }
  ...
  private long handleEmitsStructuredMarkdown(MemorySegment userData) {
    try {
      ...
      System.err.println(
          "[OcrBackendBridge] host 'emits_structured_markdown' threw; "
          + "returning default: " + e);
      return 0L;
    }
  }
