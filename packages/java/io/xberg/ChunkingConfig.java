...
public record ChunkingConfig(
    ...
    @Nullable @JsonProperty("prepend_heading_context")
    ...
    @Nullable @JsonProperty("breadcrumb_target")
  ...
  public static final class Builder {
    ...
    @Nullable
    private BreadcrumbTarget breadcrumbTarget = BreadcrumbTarget.Content;
    ...
    @JsonProperty("breadcrumb_target")
    public Builder withBreadcrumbTarget(final
                                        @Nullable BreadcrumbTarget value) {
    ...
    public ChunkingConfig build() {
      return new ChunkingConfig(
          maxCharacters, overlap, trim, chunkerType, embedding, sparseEmbedding,
          lateInteraction, preset, sizing, prependHeadingContext,
          topicThreshold, tableChunking, breadcrumbTarget);
    }
  }
  // CPD-ON
}
