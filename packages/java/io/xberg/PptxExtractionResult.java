...
public record PptxExtractionResult(
    ...
    @Nullable @JsonProperty("office_metadata")
    Map<String, String> officeMetadata,
  ...
  public static final class Builder {
    ...
    @Nullable
    private Map<String, String> officeMetadata;
    ...
    public PptxExtractionResult build() {
      return new PptxExtractionResult(
          content, metadata, slideCount, imageCount, tableCount, images,
          pageStructure, pageContents, document, officeMetadata, revisions);
    }
  }
  // CPD-ON
}
