...
public record ExtractedDocument(
    ...
    @Nullable @JsonProperty("processing_warnings")
  ...
  public static final class Builder {
    ...
    @Nullable
    private List<ProcessingWarning> processingWarnings;
    ...
    @Nullable
    private List<PdfFormField> formFields;
    ...
    public ExtractedDocument build() {
      return new ExtractedDocument(
          ...
          detectedLanguages, chunks, images, pages, elements, djotContent,
          ocrElements, document, extractedKeywords, qualityScore,
          processingWarnings, annotations, children, uris, revisions,
          structuredOutput, codeIntelligence, llmUsage, entities, summary,
          extractionConfidence, translation, pageClassifications,
          redactionReport, formulas, formFields, formattedContent);
    }
  }
  // CPD-ON
}
