...
public final class PostProcessorBridge implements AutoCloseable {
  ...
  private long handleShouldProcess(MemorySegment userData,
    ...
    try {
      ...
      System.err.println("[PostProcessorBridge] host 'should_process' threw; "
                         + "returning default: " + e);
      return 0L;
    }
  }
  ...
  private long handleEstimatedDurationMs(MemorySegment userData,
    ...
    try {
      ...
      System.err.println("[PostProcessorBridge] host 'estimated_duration_ms' "
  ...
  private long handlePriority(MemorySegment userData) {
    try {
      ...
      System.err.println(
          "[PostProcessorBridge] host 'priority' threw; returning default: " +
          e);
      return 0L;
    }
  }
