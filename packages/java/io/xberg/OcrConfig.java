...
public record OcrConfig(
  ...
  public static final class Builder {
    ...
    public OcrConfig build() {
      return new OcrConfig(enabled, backend, language, tesseractConfig,
                           outputFormat, paddleOcrConfig, backendOptions,
                           elementConfig, qualityThresholds, pipeline,
                           autoRotate, vlmFallback, vlmConfig, vlmPrompt,
                           acceleration, tessdataBytes, tessdataPath);
    }
  }
  // CPD-ON
}
