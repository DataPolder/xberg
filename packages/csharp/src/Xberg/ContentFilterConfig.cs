...
public sealed record ContentFilterConfig {
  ...
  /// classify page-header / page-footer regions as furniture on a per-page
  /// basis. To preserve those regions, set `include_headers = true`,
  /// `include_footers = true`, or both, in addition to disabling this flag.
  ///
