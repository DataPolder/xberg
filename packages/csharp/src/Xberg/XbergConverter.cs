...
// alef:hash:b1049e48b159966b070baf52cfd0651130fba401e56ee81029aee9567febf3f0
#nullable enable
...
public static class XbergConverter
{
    ...
    /// </summary>
    /// <param name="layout_enabled">Whether layout detection will run for this extraction.</param>
    ///
    /// <param name="output_format">The resolved output format the extraction will render.</param>
    ///
    /// <returns>`true` when layout is enabled and the output format is `Plain` — the
    /// layout work will be computed and its structure discarded.</returns>
    /// <param name="layoutEnabled"></param>
    /// <param name="outputFormat"></param>
    public static bool LayoutWastesPlainOutput(bool layoutEnabled, OutputFormat outputFormat)
    {
        var outputFormatHandle = (int)outputFormat;
        var nativeResult = NativeMethods.LayoutWastesPlainOutput(
            (layoutEnabled ? 1 : 0),
            outputFormatHandle
        );
    ...
    {
        var nativeResult = NativeMethods.TakeXbergNativePdfRenderWarnings();
        if (NativeMethods.LastErrorCode() != 0)
        {
            throw GetLastError();
        }
