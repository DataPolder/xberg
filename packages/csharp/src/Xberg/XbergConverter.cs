...
public static class XbergConverter {
  ...
  /// </summary>
  /// <returns>A vector of `SupportedFormat` entries sorted by
  /// extension.</returns>
  ...
  /// partial failures on a subset of batches are recorded as
  /// `ProcessingWarning`s by the caller instead of aborting the whole run (see
