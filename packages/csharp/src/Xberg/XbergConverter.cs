...
// alef:hash:cdf30471ea1e48317df8e1a95e2aafbe965f25d2b4e8edd03bd8418d09e8f0d4
#nullable enable
...
public static class XbergConverter
{
    ...
    private static Exception GetLastError()
    {
        ...
        if (message.StartsWith("Invalid heuristics configuration:")) return new ConfigErrorException(message);
        if (message.StartsWith("PDF analysis failed:")) return new PdfAnalysisErrorException(message);
        if (code == 2) return new HeuristicsErrorException(message);
