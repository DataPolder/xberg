...
public sealed record ExtractedDocument {
  ...
  ///
  /// Populated during `derive_extraction_result` before tree derivation
  /// consumes element data. `apply_output_format` swaps this into `content` at
  /// the end of the pipeline, after post-processors have operated on plain
  /// text.
  /// </summary>
