...
// alef:hash:41f5aef03ef7a039c558b5ee9bfdbdefa7ddda5ba086bd301b77dd7f52b7aeb5
...
#![allow(clippy::redundant_field_names, clippy::collapsible_if, clippy::vec_init_then_push)]
...
pub fn layout_wastes_plain_output(layout_enabled: bool, output_format: OutputFormat) -> bool {
    xberg::core::config_validation::layout_wastes_plain_output(layout_enabled, &output_format.clone().into())
}
...
pub fn classify_chunks_async(result: Option<String>, config: ChunkClassificationConfig) -> Result<(), String> {
    let result_core: Option<xberg::ExtractedDocument> = result
        ...
        .transpose()
        .map_err(|error| format!("failed to deserialize parameter `result` for `classify_chunks_async`: {error}"))?;
