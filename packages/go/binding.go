...
// alef:hash:3a7eb2a57b0f124a4a82b8e4282c313190e18ae3b53964bdb4706a0173851995
...
// InstallPdfRenderDiagnostics install the glyph-drop capture as the process-wide `tracing`
...
// TakeXbergNativePdfRenderWarnings drain the glyph-drop [`ProcessingWarning`]s accumulated on this thread by
...
func TakeXbergNativePdfRenderWarnings() []ProcessingWarning {
	ptr := C.xberg_take_xberg_native_pdf_render_warnings()
