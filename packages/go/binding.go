...
const (
	// BreadcrumbTargetContent BreadcrumbTargetContent prepend the heading breadcrumb into chunk `content`, and keep `heading_path`
	...
	// BreadcrumbTargetMetadata BreadcrumbTargetMetadata leave `content` untouched; rely on `ChunkMetadata::heading_path` only.
