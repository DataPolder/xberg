...
go get github.com/xberg-io/xberg/packages/go@v1.0.0-rc.42
```
...
curl -LO https://github.com/xberg-io/xberg/releases/download/v1.0.0-rc.42/go-ffi-linux-x86_64.tar.gz
