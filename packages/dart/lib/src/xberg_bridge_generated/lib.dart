...
Future<void>  ensureInitialized() => RustLib.instance.api.crateEnsureInitialized();
...
Future<void>  classifyChunks({required ExtractedDocument result , required ChunkClassificationConfig config }) => RustLib.instance.api.crateClassifyChunks(result: result, config: config);
...
Future<DoctorReport>  doctor({required ExtractionConfig config }) => RustLib.instance.api.crateDoctor(config: config);
...
Future<bool>  installPdfRenderDiagnostics() => RustLib.instance.api.crateInstallPdfRenderDiagnostics();
...
Future<List<ProcessingWarning>>  takeXbergNativePdfRenderWarnings() => RustLib.instance.api.crateTakeXbergNativePdfRenderWarnings();
...
Future<Int64List>  buildDecoderPromptTokens({required PlatformInt64 startOfTranscript , required PlatformInt64 langId , required PlatformInt64 transcribe , required PlatformInt64 noTimestamps , required bool timestamps }) => RustLib.instance.api.crateBuildDecoderPromptTokens(startOfTranscript: startOfTranscript, langId: langId, transcribe: transcribe, noTimestamps: noTimestamps, timestamps: timestamps);
...
Future<PlatformInt64>  timestampTokenToMs({required PlatformInt64 tokenId , required PlatformInt64 timestampBeginId }) => RustLib.instance.api.crateTimestampTokenToMs(tokenId: tokenId, timestampBeginId: timestampBeginId);
...
Future<ChunkClassificationDefinition>  createChunkClassificationDefinitionFromJson({required String json }) => RustLib.instance.api.crateCreateChunkClassificationDefinitionFromJson(json: json);

Future<ChunkClassificationConfig>  createChunkClassificationConfigFromJson({required String json }) => RustLib.instance.api.crateCreateChunkClassificationConfigFromJson(json: json);
...
Future<CsvConfig>  createCsvConfigFromJson({required String json }) => RustLib.instance.api.crateCreateCsvConfigFromJson(json: json);
...
Future<LlmProviderConfig>  createLlmProviderConfigFromJson({required String json }) => RustLib.instance.api.crateCreateLlmProviderConfigFromJson(json: json);

Future<LlmCacheConfig>  createLlmCacheConfigFromJson({required String json }) => RustLib.instance.api.crateCreateLlmCacheConfigFromJson(json: json);

Future<LlmBudgetConfig>  createLlmBudgetConfigFromJson({required String json }) => RustLib.instance.api.crateCreateLlmBudgetConfigFromJson(json: json);

Future<LlmRateLimitConfig>  createLlmRateLimitConfigFromJson({required String json }) => RustLib.instance.api.crateCreateLlmRateLimitConfigFromJson(json: json);

Future<BedrockConfig>  createBedrockConfigFromJson({required String json }) => RustLib.instance.api.crateCreateBedrockConfigFromJson(json: json);
...
Future<LanguageConfidence>  createLanguageConfidenceFromJson({required String json }) => RustLib.instance.api.crateCreateLanguageConfidenceFromJson(json: json);
...
Future<PageSpan>  createPageSpanFromJson({required String json }) => RustLib.instance.api.crateCreatePageSpanFromJson(json: json);
...
Future<DoctorCheck>  createDoctorCheckFromJson({required String json }) => RustLib.instance.api.crateCreateDoctorCheckFromJson(json: json);

Future<DoctorReport>  createDoctorReportFromJson({required String json }) => RustLib.instance.api.crateCreateDoctorReportFromJson(json: json);
...
Future<OcrBackendDartImpl>  createOcrBackendDartImpl({required String pluginName , required String pluginVersion , required FutureOr<ExtractedDocument> Function(Uint8List, OcrConfig) processImage , required FutureOr<ExtractedDocument> Function(String, OcrConfig) processImageFile , required FutureOr<bool> Function(String) supportsLanguage , required FutureOr<OcrBackendType> Function() backendType , required FutureOr<List<String>> Function() supportedLanguages , required FutureOr<bool> Function() supportsTableDetection , required FutureOr<bool> Function() supportsDocumentProcessing , required FutureOr<bool> Function() emitsStructuredMarkdown , required FutureOr<ConfidenceSemantics> Function() confidenceSemantics , required FutureOr<PageOrientationHandling> Function() pageOrientationHandling , required FutureOr<ExtractedDocument> Function(String, OcrConfig) processDocument }) => RustLib.instance.api.crateCreateOcrBackendDartImpl(pluginName: pluginName, pluginVersion: pluginVersion, processImage: processImage, processImageFile: processImageFile, supportsLanguage: supportsLanguage, backendType: backendType, supportedLanguages: supportedLanguages, supportsTableDetection: supportsTableDetection, supportsDocumentProcessing: supportsDocumentProcessing, emitsStructuredMarkdown: emitsStructuredMarkdown, confidenceSemantics: confidenceSemantics, pageOrientationHandling: pageOrientationHandling, processDocument: processDocument);
...
final String? sessionToken;
                ...
                const BedrockConfig({this.region ,this.crossRegionPrefix ,this.accessKeyId ,this.secretAccessKey ,this.sessionToken ,});
        ...
        @override
        int get hashCode => region.hashCode^crossRegionPrefix.hashCode^accessKeyId.hashCode^secretAccessKey.hashCode^sessionToken.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is BedrockConfig &&
                runtimeType == other.runtimeType
                && region == other.region&& crossRegionPrefix == other.crossRegionPrefix&& accessKeyId == other.accessKeyId&& secretAccessKey == other.secretAccessKey&& sessionToken == other.sessionToken;
...
final ChunkMetadata metadata;
                ...
                const Chunk({required this.content ,required this.chunkType ,this.embedding ,this.sparseEmbedding ,this.lateInteraction ,required this.metadata ,});
        ...
        @override
        int get hashCode => content.hashCode^chunkType.hashCode^embedding.hashCode^sparseEmbedding.hashCode^lateInteraction.hashCode^metadata.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is Chunk &&
                runtimeType == other.runtimeType
                && content == other.content&& chunkType == other.chunkType&& embedding == other.embedding&& sparseEmbedding == other.sparseEmbedding&& lateInteraction == other.lateInteraction&& metadata == other.metadata;
...
final PlatformInt64 maxConcurrency;
                ...
                const ChunkClassificationConfig({this.promptTemplate ,required this.definitions ,required this.llm ,required this.batchSize ,required this.maxConcurrency ,});
        ...
        @override
        int get hashCode => promptTemplate.hashCode^definitions.hashCode^llm.hashCode^batchSize.hashCode^maxConcurrency.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is ChunkClassificationConfig &&
                runtimeType == other.runtimeType
                && promptTemplate == other.promptTemplate&& definitions == other.definitions&& llm == other.llm&& batchSize == other.batchSize&& maxConcurrency == other.maxConcurrency;
...
final String description;
                ...
                const ChunkClassificationDefinition({required this.label ,required this.description ,});
        ...
        bool operator ==(Object other) =>
            ...
            other is ChunkClassificationDefinition &&
                runtimeType == other.runtimeType
                && label == other.label&& description == other.description;
...
final List<ClassificationLabel> classifications;
                ...
                const ChunkMetadata({required this.byteStart ,required this.byteEnd ,this.tokenCount ,required this.chunkIndex ,required this.totalChunks ,this.firstPage ,this.lastPage ,this.headingContext ,required this.headingPath ,required this.imageIndices ,required this.nodeIds ,required this.pageSpans ,required this.classifications ,});
        ...
        @override
        int get hashCode => byteStart.hashCode^byteEnd.hashCode^tokenCount.hashCode^chunkIndex.hashCode^totalChunks.hashCode^firstPage.hashCode^lastPage.hashCode^headingContext.hashCode^headingPath.hashCode^imageIndices.hashCode^nodeIds.hashCode^pageSpans.hashCode^classifications.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is ChunkMetadata &&
                runtimeType == other.runtimeType
                && byteStart == other.byteStart&& byteEnd == other.byteEnd&& tokenCount == other.tokenCount&& chunkIndex == other.chunkIndex&& totalChunks == other.totalChunks&& firstPage == other.firstPage&& lastPage == other.lastPage&& headingContext == other.headingContext&& headingPath == other.headingPath&& imageIndices == other.imageIndices&& nodeIds == other.nodeIds&& pageSpans == other.pageSpans&& classifications == other.classifications;
...
final BreadcrumbTarget breadcrumbTarget;
                ...
                const ChunkingConfig({required this.maxCharacters ,required this.overlap ,required this.trim ,required this.chunkerType ,this.embedding ,this.sparseEmbedding ,this.lateInteraction ,this.preset ,required this.sizing ,required this.prependHeadingContext ,this.topicThreshold ,required this.tableChunking ,required this.breadcrumbTarget ,});
        ...
        @override
        int get hashCode => maxCharacters.hashCode^overlap.hashCode^trim.hashCode^chunkerType.hashCode^embedding.hashCode^sparseEmbedding.hashCode^lateInteraction.hashCode^preset.hashCode^sizing.hashCode^prependHeadingContext.hashCode^topicThreshold.hashCode^tableChunking.hashCode^breadcrumbTarget.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is ChunkingConfig &&
                runtimeType == other.runtimeType
                && maxCharacters == other.maxCharacters&& overlap == other.overlap&& trim == other.trim&& chunkerType == other.chunkerType&& embedding == other.embedding&& sparseEmbedding == other.sparseEmbedding&& lateInteraction == other.lateInteraction&& preset == other.preset&& sizing == other.sizing&& prependHeadingContext == other.prependHeadingContext&& topicThreshold == other.topicThreshold&& tableChunking == other.tableChunking&& breadcrumbTarget == other.breadcrumbTarget;
...
const factory ConfidenceSemantics.legibility({ /// The upper bound of the reported confidence scale (e.g. `100.0` for Tesseract).
  required double scaleMax , }) = ConfidenceSemantics_Legibility;
 /// A number is reported, but it is not validated to correlate with legibility.
/// Never gate on it.
const factory ConfidenceSemantics.uncalibrated() = ConfidenceSemantics_Uncalibrated;
...
final bool includeWatermarks;
                ...
                const ContentFilterConfig({required this.includeHeaders ,required this.includeFooters ,required this.includeFootnotes ,required this.stripRepeatingText ,required this.includeWatermarks ,});
        ...
        @override
        int get hashCode => includeHeaders.hashCode^includeFooters.hashCode^includeFootnotes.hashCode^stripRepeatingText.hashCode^includeWatermarks.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is ContentFilterConfig &&
                runtimeType == other.runtimeType
                && includeHeaders == other.includeHeaders&& includeFooters == other.includeFooters&& includeFootnotes == other.includeFootnotes&& stripRepeatingText == other.stripRepeatingText&& includeWatermarks == other.includeWatermarks;
...
final bool? ssrfDenyPrivateExplicit;
        ...
        @override
        int get hashCode => maxDepth.hashCode^maxPages.hashCode^maxLinksPerPage.hashCode^maxConcurrent.hashCode^crawlStrategy.hashCode^contentFilter.hashCode^bm25Query.hashCode^bm25Threshold.hashCode^respectRobotsTxt.hashCode^softHttpErrors.hashCode^userAgent.hashCode^stayOnDomain.hashCode^allowSubdomains.hashCode^includePaths.hashCode^excludePaths.hashCode^customHeaders.hashCode^requestTimeout.hashCode^rateLimitMs.hashCode^maxRedirects.hashCode^retryCount.hashCode^retryCodes.hashCode^cookiesEnabled.hashCode^auth.hashCode^maxBodySize.hashCode^removeTags.hashCode^content.hashCode^mapLimit.hashCode^mapSearch.hashCode^downloadAssets.hashCode^assetTypes.hashCode^maxAssetSize.hashCode^browser.hashCode^proxy.hashCode^userAgents.hashCode^captureScreenshot.hashCode^followDocumentUrls.hashCode^documentUrlDepth.hashCode^downloadDocuments.hashCode^documentMaxSize.hashCode^documentMimeTypes.hashCode^documentOutputDir.hashCode^documentContentEncoding.hashCode^warcOutput.hashCode^browserProfile.hashCode^saveBrowserProfile.hashCode^ssrf.hashCode^ssrfDenyPrivateExplicit.hashCode;
...
const factory CredentialProviderConfig.azureAd({ /// Azure AD tenant ID.
  required String tenantId ,/// Application (client) ID.
  required String clientId ,/// Client secret value. Secret — never logged.
  required String clientSecret ,/// OAuth2 scope. Defaults to liter-llm's own
/// `https://cognitiveservices.azure.com/.default` when unset.
  required String scope , }) = CredentialProviderConfig_AzureAd;
...
/// follows.
const factory CredentialProviderConfig.vertexOauth2({ /// Path to a Google service-account JSON key file (the same file
/// `GOOGLE_APPLICATION_CREDENTIALS` would point to).
  required String serviceAccountKeyFile ,/// OAuth2 scope. Defaults to liter-llm's own Vertex AI scope when unset.
  required String scope , }) = CredentialProviderConfig_VertexOauth2;
...
const factory CredentialProviderConfig.vertexAdc({ /// OAuth2 scope. Defaults to liter-llm's own Vertex AI scope when unset.
  required String scope , }) = CredentialProviderConfig_VertexAdc;
 /// AWS STS `AssumeRoleWithWebIdentity` (EKS IRSA / OIDC federation) for Bedrock.
const factory CredentialProviderConfig.bedrockWebIdentity({ /// ARN of the IAM role to assume.
  required String roleArn ,/// Path to a file containing the OIDC JWT (the same file
/// `AWS_WEB_IDENTITY_TOKEN_FILE` would point to).
  required String tokenFile ,/// STS session name. Defaults to liter-llm's own default (`"liter-llm-session"`) when
/// unset.
  required String sessionName ,/// AWS region. Defaults to liter-llm's own default (`"us-east-1"`) when unset.
  required String region , }) = CredentialProviderConfig_BedrockWebIdentity;
...
final List<String> commentPrefixes;
        ...
        bool operator ==(Object other) =>
            ...
            other is CsvConfig &&
                runtimeType == other.runtimeType
                && delimiter == other.delimiter&& commentPrefixes == other.commentPrefixes;
...
final String message;
                ...
                const DoctorCheck({required this.name ,required this.status ,required this.message ,});
        ...
        bool operator ==(Object other) =>
            ...
            other is DoctorCheck &&
                runtimeType == other.runtimeType
                && name == other.name&& status == other.status&& message == other.message;
...
final List<PdfFormField> formFields;
                ...
                const ExtractedDocument({required this.content ,required this.mimeType ,required this.metadata ,this.extractionMethod ,required this.tables ,required this.counts ,this.detectedLanguages ,this.detectedLanguageConfidences ,this.chunks ,this.images ,this.pages ,this.elements ,this.djotContent ,this.ocrElements ,this.document ,this.extractedKeywords ,this.qualityScore ,required this.processingWarnings ,this.annotations ,this.children ,this.uris ,this.revisions ,this.structuredOutput ,this.codeIntelligence ,this.llmUsage ,this.entities ,this.summary ,this.extractionConfidence ,this.translation ,this.pageClassifications ,this.redactionReport ,required this.formulas ,required this.formFields ,});
...
final bool? qrCodes;
        ...
        bool operator ==(Object other) =>
            ...
            other is ExtractionConfig &&
                runtimeType == other.runtimeType
                && useCache == other.useCache&& enableQualityProcessing == other.enableQualityProcessing&& ocr == other.ocr&& forceOcr == other.forceOcr&& ocrStrategy == other.ocrStrategy&& forceOcrPages == other.forceOcrPages&& disableOcr == other.disableOcr&& chunking == other.chunking&& contentFilter == other.contentFilter&& images == other.images&& pdfOptions == other.pdfOptions&& tokenReduction == other.tokenReduction&& languageDetection == other.languageDetection&& pages == other.pages&& keywords == other.keywords&& postprocessor == other.postprocessor&& htmlOptions == other.htmlOptions&& htmlOutput == other.htmlOutput&& extractionTimeoutSecs == other.extractionTimeoutSecs&& maxConcurrentExtractions == other.maxConcurrentExtractions&& resultFormat == other.resultFormat&& securityLimits == other.securityLimits&& maxEmbeddedFileBytes == other.maxEmbeddedFileBytes&& outputFormat == other.outputFormat&& escapeMarkdown == other.escapeMarkdown&& tableAnchors == other.tableAnchors&& jupyterCellRendering == other.jupyterCellRendering&& layout == other.layout&& transcription == other.transcription&& useLayoutForMarkdown == other.useLayoutForMarkdown&& includeDocumentStructure == other.includeDocumentStructure&& acceleration == other.acceleration&& cacheNamespace == other.cacheNamespace&& cacheTtlSecs == other.cacheTtlSecs&& email == other.email&& csv == other.csv&& url == other.url&& maxArchiveDepth == other.maxArchiveDepth&& treeSitter == other.treeSitter&& structuredExtraction == other.structuredExtraction&& ner == other.ner&& redaction == other.redaction&& summarization == other.summarization&& translation == other.translation&& pageClassification == other.pageClassification&& chunkClassification == other.chunkClassification&& captioning == other.captioning&& qrCodes == other.qrCodes;
...
const factory HostMatcher.exact({ /// The hostname to match.
  required String value , }) = HostMatcher_Exact;
 /// Suffix match: ".xberg.io" matches "api.xberg.io" and "xberg.io".
const factory HostMatcher.suffix({ /// The dot-prefixed suffix to match. A leading dot is optional.
  required String value , }) = HostMatcher_Suffix;
 /// CIDR match: "10.0.0.0/8" matches IP addresses in that range.
const factory HostMatcher.cidr({ /// The CIDR block. Validated when built through [`HostMatcher::cidr`] or
/// deserialization.
  required String value , }) = HostMatcher_Cidr;
...
final bool reliable;
                ...
                const LanguageConfidence({required this.language ,required this.confidence ,required this.proportion ,required this.script ,required this.reliable ,});
        ...
        @override
        int get hashCode => language.hashCode^confidence.hashCode^proportion.hashCode^script.hashCode^reliable.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is LanguageConfidence &&
                runtimeType == other.runtimeType
                && language == other.language&& confidence == other.confidence&& proportion == other.proportion&& script == other.script&& reliable == other.reliable;
...
final bool enableChartUnderstanding;
                ...
                const LayoutDetectionConfig({required this.strategy ,this.confidenceThreshold ,required this.applyHeuristics ,required this.tableModel ,this.formulaModel ,required this.tableOverlapPreference ,this.acceleration ,required this.enableChartUnderstanding ,});
        ...
        @override
        int get hashCode => strategy.hashCode^confidenceThreshold.hashCode^applyHeuristics.hashCode^tableModel.hashCode^formulaModel.hashCode^tableOverlapPreference.hashCode^acceleration.hashCode^enableChartUnderstanding.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is LayoutDetectionConfig &&
                runtimeType == other.runtimeType
                && strategy == other.strategy&& confidenceThreshold == other.confidenceThreshold&& applyHeuristics == other.applyHeuristics&& tableModel == other.tableModel&& formulaModel == other.formulaModel&& tableOverlapPreference == other.tableOverlapPreference&& acceleration == other.acceleration&& enableChartUnderstanding == other.enableChartUnderstanding;
...
final String? enforcement;
        ...
        @override
        int get hashCode => globalLimit.hashCode^modelLimits.hashCode^enforcement.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is LlmBudgetConfig &&
                runtimeType == other.runtimeType
                && globalLimit == other.globalLimit&& modelLimits == other.modelLimits&& enforcement == other.enforcement;
...
final Map<String, String>? backendConfig;
                ...
                const LlmCacheConfig({this.maxEntries ,this.ttlSeconds ,this.backend ,this.backendConfig ,});
        ...
        @override
        int get hashCode => maxEntries.hashCode^ttlSeconds.hashCode^backend.hashCode^backendConfig.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is LlmCacheConfig &&
                runtimeType == other.runtimeType
                && maxEntries == other.maxEntries&& ttlSeconds == other.ttlSeconds&& backend == other.backend&& backendConfig == other.backendConfig;
...
final PlatformInt64? maxConcurrency;
                ...
                const LlmConfig({required this.model ,this.apiKey ,this.baseUrl ,this.timeoutSecs ,this.maxRetries ,this.temperature ,this.maxTokens ,this.topP ,this.stop ,this.seed ,this.presencePenalty ,this.frequencyPenalty ,this.reasoningEffort ,this.extraBody ,this.loadEnv ,this.headers ,this.providers ,this.cache ,this.budget ,this.rateLimit ,this.costTracking ,this.tracing ,this.cooldownSecs ,this.healthCheckSecs ,this.bedrock ,this.credentialProvider ,this.maxConcurrency ,});
        ...
        @override
        int get hashCode => model.hashCode^apiKey.hashCode^baseUrl.hashCode^timeoutSecs.hashCode^maxRetries.hashCode^temperature.hashCode^maxTokens.hashCode^topP.hashCode^stop.hashCode^seed.hashCode^presencePenalty.hashCode^frequencyPenalty.hashCode^reasoningEffort.hashCode^extraBody.hashCode^loadEnv.hashCode^headers.hashCode^providers.hashCode^cache.hashCode^budget.hashCode^rateLimit.hashCode^costTracking.hashCode^tracing.hashCode^cooldownSecs.hashCode^healthCheckSecs.hashCode^bedrock.hashCode^credentialProvider.hashCode^maxConcurrency.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is LlmConfig &&
                runtimeType == other.runtimeType
                && model == other.model&& apiKey == other.apiKey&& baseUrl == other.baseUrl&& timeoutSecs == other.timeoutSecs&& maxRetries == other.maxRetries&& temperature == other.temperature&& maxTokens == other.maxTokens&& topP == other.topP&& stop == other.stop&& seed == other.seed&& presencePenalty == other.presencePenalty&& frequencyPenalty == other.frequencyPenalty&& reasoningEffort == other.reasoningEffort&& extraBody == other.extraBody&& loadEnv == other.loadEnv&& headers == other.headers&& providers == other.providers&& cache == other.cache&& budget == other.budget&& rateLimit == other.rateLimit&& costTracking == other.costTracking&& tracing == other.tracing&& cooldownSecs == other.cooldownSecs&& healthCheckSecs == other.healthCheckSecs&& bedrock == other.bedrock&& credentialProvider == other.credentialProvider&& maxConcurrency == other.maxConcurrency;
...
final List<String> modelPrefixes;
                ...
                const LlmProviderConfig({required this.name ,required this.baseUrl ,this.authHeader ,required this.modelPrefixes ,});
        ...
        @override
        int get hashCode => name.hashCode^baseUrl.hashCode^authHeader.hashCode^modelPrefixes.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is LlmProviderConfig &&
                runtimeType == other.runtimeType
                && name == other.name&& baseUrl == other.baseUrl&& authHeader == other.authHeader&& modelPrefixes == other.modelPrefixes;
...
final PlatformInt64? windowSeconds;
        ...
        bool operator ==(Object other) =>
            ...
            other is LlmRateLimitConfig &&
                runtimeType == other.runtimeType
                && rpm == other.rpm&& tpm == other.tpm&& windowSeconds == other.windowSeconds;
...
const factory NodeContent.comment({ /// The comment body text.
  required String text , }) = NodeContent_Comment;
...
final double minProvenanceFallbackRatio;
                ...
                const OcrQualityThresholds({required this.minTotalNonWhitespace ,required this.minNonWhitespacePerPage ,required this.minMeaningfulWordLen ,required this.minMeaningfulWords ,required this.minAlnumRatio ,required this.minGarbageChars ,required this.maxFragmentedWordRatio ,required this.criticalFragmentedWordRatio ,required this.maxOcrOutputFragmentedWordRatio ,required this.minOcrMeanConfidence ,required this.minWordsForOcrOutputCheck ,required this.maxOcrOutputDictInvalidWordRatio ,required this.minAvgWordLength ,required this.minWordsForAvgLengthCheck ,required this.minConsecutiveRepeatRatio ,required this.minWordsForRepeatCheck ,required this.substantiveMinChars ,required this.nonTextMinChars ,required this.alnumWsRatioThreshold ,required this.pipelineMinQuality ,required this.minUndecodableRatio ,required this.enableProvenanceOcrRouting ,required this.minProvenanceFallbackRatio ,});
...
final PaddleInferenceBackend? inferenceBackend;
        ...
        @override
        int get hashCode => language.hashCode^cacheDir.hashCode^useAngleCls.hashCode^enableTableDetection.hashCode^detDbThresh.hashCode^detDbBoxThresh.hashCode^detDbUnclipRatio.hashCode^detLimitSideLen.hashCode^recBatchNum.hashCode^padding.hashCode^dropScore.hashCode^modelTier.hashCode^modelVersion.hashCode^inferenceBackend.hashCode;
...
final BoundingBox? bbox;
        ...
        bool operator ==(Object other) =>
            ...
            other is PageSpan &&
                runtimeType == other.runtimeType
                && page == other.page&& bbox == other.bbox;
...
final String? markedText;
                ...
                const PdfAnnotation({required this.annotationType ,this.content ,required this.pageNumber ,this.boundingBox ,this.author ,this.modified ,this.color ,this.subject ,this.quadPoints ,this.markedText ,});
        ...
        @override
        int get hashCode => annotationType.hashCode^content.hashCode^pageNumber.hashCode^boundingBox.hashCode^author.hashCode^modified.hashCode^color.hashCode^subject.hashCode^quadPoints.hashCode^markedText.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is PdfAnnotation &&
                runtimeType == other.runtimeType
                && annotationType == other.annotationType&& content == other.content&& pageNumber == other.pageNumber&& boundingBox == other.boundingBox&& author == other.author&& modified == other.modified&& color == other.color&& subject == other.subject&& quadPoints == other.quadPoints&& markedText == other.markedText;
...
final List<String>? layoutGateReasons;
                ...
                const PdfMetadata({this.pdfVersion ,this.producer ,this.isEncrypted ,this.width ,this.height ,this.pageCount ,this.scannedConfidence ,this.scannedPages ,this.layoutGatedPages ,this.layoutGateReasons ,});
        ...
        @override
        int get hashCode => pdfVersion.hashCode^producer.hashCode^isEncrypted.hashCode^width.hashCode^height.hashCode^pageCount.hashCode^scannedConfidence.hashCode^scannedPages.hashCode^layoutGatedPages.hashCode^layoutGateReasons.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is PdfMetadata &&
                runtimeType == other.runtimeType
                && pdfVersion == other.pdfVersion&& producer == other.producer&& isEncrypted == other.isEncrypted&& width == other.width&& height == other.height&& pageCount == other.pageCount&& scannedConfidence == other.scannedConfidence&& scannedPages == other.scannedPages&& layoutGatedPages == other.layoutGatedPages&& layoutGateReasons == other.layoutGateReasons;
...
final PlatformInt64? maxPages;
                ...
                const SecurityLimits({required this.maxArchiveSize ,required this.maxCompressionRatio ,required this.maxFilesInArchive ,required this.maxNestingDepth ,required this.maxEntityLength ,required this.maxContentSize ,required this.maxIterations ,required this.maxXmlDepth ,required this.maxTableCells ,this.maxPages ,});
        ...
        @override
        int get hashCode => maxArchiveSize.hashCode^maxCompressionRatio.hashCode^maxFilesInArchive.hashCode^maxNestingDepth.hashCode^maxEntityLength.hashCode^maxContentSize.hashCode^maxIterations.hashCode^maxXmlDepth.hashCode^maxTableCells.hashCode^maxPages.hashCode;
...
final PlatformInt64 maxRedirects;
                ...
                const SsrfPolicy({required this.denyPrivate ,required this.allowlist ,required this.maxRedirects ,});
        ...
        @override
        int get hashCode => denyPrivate.hashCode^allowlist.hashCode^maxRedirects.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is SsrfPolicy &&
                runtimeType == other.runtimeType
                && denyPrivate == other.denyPrivate&& allowlist == other.allowlist&& maxRedirects == other.maxRedirects;
...
final List<String> flattened;
                ...
                const StructuredDataResult({required this.content ,required this.format ,required this.metadata ,required this.textFields ,this.value ,required this.flattened ,});
        ...
        @override
        int get hashCode => content.hashCode^format.hashCode^metadata.hashCode^textFields.hashCode^value.hashCode^flattened.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is StructuredDataResult &&
                runtimeType == other.runtimeType
                && content == other.content&& format == other.format&& metadata == other.metadata&& textFields == other.textFields&& value == other.value&& flattened == other.flattened;
...
final List<String>? columns;
                ...
                const Table({required this.cells ,required this.markdown ,required this.pageNumber ,this.boundingBox ,this.tableId ,this.columns ,});
        ...
        @override
        int get hashCode => cells.hashCode^markdown.hashCode^pageNumber.hashCode^boundingBox.hashCode^tableId.hashCode^columns.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is Table &&
                runtimeType == other.runtimeType
                && cells == other.cells&& markdown == other.markdown&& pageNumber == other.pageNumber&& boundingBox == other.boundingBox&& tableId == other.tableId&& columns == other.columns;
...
final bool preserveImportantWords;
        ...
        @override
        int get hashCode => level.hashCode^languageHint.hashCode^preserveMarkdown.hashCode^preserveCode.hashCode^semanticThreshold.hashCode^enableParallel.hashCode^useSimd.hashCode^customStopwords.hashCode^preservePatterns.hashCode^targetReduction.hashCode^enableSemanticClustering.hashCode^preserveImportantWords.hashCode;
