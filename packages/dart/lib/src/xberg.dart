...
class XbergBridge {
  ...
  static Future<DoctorReport> doctor({ExtractionConfig? config}) async {
    return await rust_bridge.doctor(config: config ?? ExtractionConfig(useCache: true, enableQualityProcessing: true, ocr: null, forceOcr: false, ocrStrategy: OcrStrategy.auto(), forceOcrPages: null, disableOcr: false, chunking: null, contentFilter: null, images: null, pdfOptions: null, tokenReduction: null, languageDetection: null, pages: null, keywords: null, postprocessor: null, htmlOptions: null, htmlOutput: null, extractionTimeoutSecs: 0, maxConcurrentExtractions: null, resultFormat: ResultFormat.unified, securityLimits: null, maxEmbeddedFileBytes: 0, outputFormat: OutputFormat.plain(), escapeMarkdown: true, tableAnchors: false, jupyterCellRendering: JupyterCellRendering.both, layout: null, transcription: null, useLayoutForMarkdown: false, includeDocumentStructure: false, acceleration: null, cacheNamespace: null, cacheTtlSecs: null, email: null, csv: null, url: UrlExtractionConfig(mode: UrlExtractionMode.auto, crawl: CrawlConfig(maxDepth: null, maxPages: null, maxConcurrent: null, respectRobotsTxt: false, softHttpErrors: false, userAgent: null, stayOnDomain: false, allowSubdomains: false, includePaths: [], excludePaths: [], customHeaders: {}, requestTimeout: 30000, rateLimitMs: null, maxRedirects: 10, retryCount: 0, retryCodes: Int64List(0), cookiesEnabled: false, auth: null, maxBodySize: null, removeTags: [], content: ContentConfig(outputFormat: 'markdown', preprocessingPreset: 'standard', removeNavigation: true, removeForms: true, stripTags: [], preserveTags: [], excludeSelectors: [], skipImages: false, maxDepth: null, wrap: false, wrapWidth: 80, includeDocumentStructure: true), mapLimit: null, mapSearch: null, downloadAssets: false, assetTypes: [], maxAssetSize: null, browser: BrowserConfig(mode: BrowserMode.auto, backend: BrowserBackend.chromiumoxide, endpoint: null, timeout: 30000, wait: BrowserWait.networkIdle, waitSelector: null, extraWait: null, proxy: null, blockUrlPatterns: [], evalScript: null, robotsUserAgent: null, captureNetworkEvents: false, sessionAffinity: true), proxy: null, userAgents: [], captureScreenshot: false, followDocumentUrls: false, documentUrlDepth: null, downloadDocuments: true, documentMaxSize: 52428800, documentMimeTypes: [], warcOutput: null, browserProfile: null, saveBrowserProfile: false, ssrf: SsrfPolicy(denyPrivate: true, maxRedirects: 5)), documentUrlPattern: null, maxDocumentUrlsPerResult: 100, maxTotalUrls: 1000, allowLocalFileInputs: true, allowFileUris: true), maxArchiveDepth: 0, treeSitter: null, structuredExtraction: null, ner: null, redaction: null, summarization: null, translation: null, pageClassification: null, chunkClassification: null, captioning: null, qrCodes: null));
  }
