...
// alef:hash:2547bc0692175b5ce4143cf309fd30c1782a7593b78527b39de9579e3e3a42b8
...
class XbergBridge {
  ...
  /// ```
  static Future<bool> layoutWastesPlainOutput(bool layoutEnabled, OutputFormat outputFormat) async {
    return await rust_bridge.layoutWastesPlainOutput(layoutEnabled: layoutEnabled, outputFormat: outputFormat);
  }
  ...
  static Future<List<ProcessingWarning>> takeXbergNativePdfRenderWarnings() async {
    return await rust_bridge.takeXbergNativePdfRenderWarnings();
  }
...
extension BreadcrumbTargetWireValue on BreadcrumbTarget {
  /// The exact serde wire value for this variant.
  String get wireValue {
    switch (this) {
      case BreadcrumbTarget.content:
        return 'content';
      case BreadcrumbTarget.metadata:
        return 'metadata';
    }
  }
}
