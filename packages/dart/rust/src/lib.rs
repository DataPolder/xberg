...
// alef:hash:836919d76c91ba921d0e1d99c07ae040e1930095d3651eced8981d8b8d09b20d
...
#![allow(clippy::collapsible_if, clippy::vec_init_then_push)]
mod frb_generated;
...
#[frb(mirror(BreadcrumbTarget), unignore)]
...
impl From<xberg::core::config::LlmProviderConfig> for LlmProviderConfig {
    fn from(v: xberg::core::config::LlmProviderConfig) -> Self {
        LlmProviderConfig {
            name: v.name.into(),
...
impl From<xberg::core::config::LlmCacheConfig> for LlmCacheConfig {
    fn from(v: xberg::core::config::LlmCacheConfig) -> Self {
        LlmCacheConfig {
...
impl From<xberg::core::config::LlmBudgetConfig> for LlmBudgetConfig {
    fn from(v: xberg::core::config::LlmBudgetConfig) -> Self {
        LlmBudgetConfig {
...
impl From<xberg::core::config::LlmRateLimitConfig> for LlmRateLimitConfig {
    fn from(v: xberg::core::config::LlmRateLimitConfig) -> Self {
        LlmRateLimitConfig {
...
impl From<xberg::ChunkingConfig> for ChunkingConfig {
    fn from(v: xberg::ChunkingConfig) -> Self {
        ChunkingConfig {
            ...
            breadcrumb_target: BreadcrumbTarget::from(v.breadcrumb_target),
        }
    }
}
...
impl From<xberg::BreadcrumbTarget> for BreadcrumbTarget {
    fn from(v: xberg::BreadcrumbTarget) -> Self {
        match v {
            xberg::BreadcrumbTarget::Content => BreadcrumbTarget::Content,
            xberg::BreadcrumbTarget::Metadata => BreadcrumbTarget::Metadata,
        }
    }
}
...
impl From<xberg::PdfBackend> for PdfBackend {
    fn from(v: xberg::PdfBackend) -> Self {
        match v {
            xberg::PdfBackend::PdfOxide => PdfBackend::PdfOxide,
...
impl From<xberg::NodeContent> for NodeContent {
    fn from(v: xberg::NodeContent) -> Self {
        match v {
            ...
            xberg::NodeContent::Comment { text } => NodeContent::Comment { text: text },
...
impl From<LlmProviderConfig> for xberg::core::config::LlmProviderConfig {
    fn from(v: LlmProviderConfig) -> Self {
        xberg::core::config::LlmProviderConfig {
            name: v.name.into(),
            base_url: v.base_url.into(),
...
impl From<LlmCacheConfig> for xberg::core::config::LlmCacheConfig {
    fn from(v: LlmCacheConfig) -> Self {
        xberg::core::config::LlmCacheConfig {
            max_entries: v.max_entries.map(|x| x as _),
            ttl_seconds: v.ttl_seconds.map(|x| x as _),
...
impl From<LlmBudgetConfig> for xberg::core::config::LlmBudgetConfig {
    fn from(v: LlmBudgetConfig) -> Self {
        xberg::core::config::LlmBudgetConfig {
            global_limit: v.global_limit.map(|x| x as _),
            model_limits: v
                .model_limits
                .map(|m| m.into_iter().map(|(k, v)| (k.into(), v as _)).collect()),
...
impl From<LlmRateLimitConfig> for xberg::core::config::LlmRateLimitConfig {
    fn from(v: LlmRateLimitConfig) -> Self {
        xberg::core::config::LlmRateLimitConfig {
            rpm: v.rpm.map(|x| x as _),
            tpm: v.tpm.map(|x| x as _),
            window_seconds: v.window_seconds.map(|x| x as _),
            ..Default::default()
...
impl From<ChunkingConfig> for xberg::ChunkingConfig {
    fn from(v: ChunkingConfig) -> Self {
        xberg::ChunkingConfig {
            ...
            breadcrumb_target: v.breadcrumb_target.into(),
            ..Default::default()
        }
    }
}
...
impl From<BreadcrumbTarget> for xberg::BreadcrumbTarget {
    fn from(v: BreadcrumbTarget) -> Self {
        match v {
            BreadcrumbTarget::Content => xberg::BreadcrumbTarget::Content,
            BreadcrumbTarget::Metadata => xberg::BreadcrumbTarget::Metadata,
        }
    }
}
...
impl From<LateInteractionModelType> for xberg::LateInteractionModelType {
    fn from(v: LateInteractionModelType) -> Self {
        match v {
            LateInteractionModelType::Preset { name } => xberg::LateInteractionModelType::Preset { name: name },
            LateInteractionModelType::Custom {
                model_id,
                model_file,
                additional_files,
            ...
            LateInteractionModelType::Plugin { name } => xberg::LateInteractionModelType::Plugin { name: name },
        }
    }
}
...
impl From<PdfBackend> for xberg::PdfBackend {
    fn from(v: PdfBackend) -> Self {
        match v {
            PdfBackend::PdfOxide => xberg::PdfBackend::PdfOxide,
...
impl From<SparseEmbeddingModelType> for xberg::SparseEmbeddingModelType {
    fn from(v: SparseEmbeddingModelType) -> Self {
        match v {
            SparseEmbeddingModelType::Preset { name } => xberg::SparseEmbeddingModelType::Preset { name: name },
            SparseEmbeddingModelType::Custom {
                model_id,
                model_file,
                additional_files,
            ...
            SparseEmbeddingModelType::Plugin { name } => xberg::SparseEmbeddingModelType::Plugin { name: name },
        }
    }
}
...
impl From<NodeContent> for xberg::NodeContent {
    fn from(v: NodeContent) -> Self {
        match v {
            ...
            NodeContent::Comment { text } => xberg::NodeContent::Comment { text: text },
            NodeContent::Group {
                label,
                heading_level,
                heading_text,
...
pub fn layout_wastes_plain_output(layout_enabled: bool, output_format: OutputFormat) -> bool {
    xberg::core::config_validation::layout_wastes_plain_output(layout_enabled, unsafe {
        std::mem::transmute::<&OutputFormat, &xberg::OutputFormat>(&output_format)
    })
}
...
#[cfg(feature = "transcription")]
pub fn timestamp_token_to_ms(token_id: i64, timestamp_begin_id: i64) -> i64 {
    xberg::transcription::engine::timestamp_token_to_ms(token_id as u32, timestamp_begin_id as u32) as i64
}
