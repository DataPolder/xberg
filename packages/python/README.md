...
<!-- alef:hash:12bbd9080d1e0b912caaf9426122927597fecf9b995ab07b06d0f57e3dfc55c7 -->
...
Extract text, tables, images, metadata, and code intelligence from 106 file formats and 371 programming languages including PDF, Office documents, images, and audio/video transcripts where native transcription is available. Native Python bindings with async/await support, multiple OCR backends (Tesseract, PaddleOCR, Sceptre), and extensible plugin system.
