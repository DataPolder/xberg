...
Extract text, tables, images, metadata, and code intelligence from 101 file formats (115 file extensions) and 306 programming languages including PDF, Office documents, images, and audio/video transcripts where native transcription is available. Native Python bindings with async/await support, multiple OCR backends (Tesseract, PaddleOCR), and extensible plugin system.
