...
def _to_rust_chunking_config(value: ChunkingConfig | dict[str, Any] | str | None) -> _rust.ChunkingConfig | None:
    ...
    return _rust.ChunkingConfig(
        ...
        **(
            {"breadcrumb_target": _coerce_enum(_rust.BreadcrumbTarget, value.breadcrumb_target)}
            if value.breadcrumb_target is not None
            else {}
        ),
    )
...
def build_decoder_prompt_tokens(
    ...
    return _rust.build_decoder_prompt_tokens(
        start_of_transcript=start_of_transcript,
        lang_id=lang_id,
