...
class ChunkingConfig:
    ...
    """Where the heading-path breadcrumb is written when `prepend_heading_context` is `true`. See [`BreadcrumbTarget`](crate::core::config::extraction::BreadcrumbTarget) for the dense-vs-lexical retrieval trade-off. Has no effect when `prepend_heading_context` is `false`."""
