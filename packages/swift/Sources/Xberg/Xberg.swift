...
// alef:hash:e1110aefc23fff95ea93e5613204eb5e8d17597482e4ba204d3602022a787a33
...
public func takeXbergNativePdfRenderWarnings() throws -> [ProcessingWarning] {
    return try RustBridge.takeXbergNativePdfRenderWarnings().map { ref in try ProcessingWarning(ref) }
}
