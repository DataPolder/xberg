...
public struct ContentFilterConfig: Codable, Sendable, Hashable {
    ...
    public init(includeHeaders: Bool, includeFooters: Bool, includeFootnotes: Bool, stripRepeatingText: Bool, includeWatermarks: Bool) {
...
internal extension PdfMetadata {
    init(_ rb: RustBridge.PdfMetadataRef) throws {
        ...
        self.layoutGatedPages = rb.layoutGatedPages().map { Array($0) }
        self.layoutGateReasons = rb.layoutGateReasons()?.map { $0.as_str().toString() }
    }
