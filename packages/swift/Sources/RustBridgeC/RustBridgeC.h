...
// alef:hash:65edce43d609c436c5dc1705a5cfac63781105582be0178706f73c7c4aba868e
...
void __swift_bridge__$Vec_ConfidenceSemantics$push(void* vec_ptr, void* item_ptr);
void* __swift_bridge__$Vec_ConfidenceSemantics$pop(void* vec_ptr);
void* __swift_bridge__$Vec_ConfidenceSemantics$get(void* vec_ptr, uintptr_t index);
void* __swift_bridge__$Vec_ConfidenceSemantics$get_mut(void* vec_ptr, uintptr_t index);
...
void __swift_bridge__$Vec_PageOrientationHandling$push(void* vec_ptr, void* item_ptr);
void* __swift_bridge__$Vec_PageOrientationHandling$pop(void* vec_ptr);
void* __swift_bridge__$Vec_PageOrientationHandling$get(void* vec_ptr, uintptr_t index);
void* __swift_bridge__$Vec_PageOrientationHandling$get_mut(void* vec_ptr, uintptr_t index);
...
struct __private__OptionUsize __swift_bridge__$LlmConfig$max_concurrency(void* self);
...
void* __swift_bridge__$OcrQualityThresholds$new(uintptr_t min_total_non_whitespace, double min_non_whitespace_per_page, uintptr_t min_meaningful_word_len, uintptr_t min_meaningful_words, double min_alnum_ratio, uintptr_t min_garbage_chars, double max_fragmented_word_ratio, double critical_fragmented_word_ratio, double max_ocr_output_fragmented_word_ratio, double min_ocr_mean_confidence, uintptr_t min_words_for_ocr_output_check, double max_ocr_output_dict_invalid_word_ratio, double min_avg_word_length, uintptr_t min_words_for_avg_length_check, double min_consecutive_repeat_ratio, uintptr_t min_words_for_repeat_check, uintptr_t substantive_min_chars, uintptr_t non_text_min_chars, double alnum_ws_ratio_threshold, double pipeline_min_quality, double min_undecodable_ratio, bool enable_provenance_ocr_routing, double min_provenance_fallback_ratio);
...
double __swift_bridge__$OcrQualityThresholds$max_ocr_output_fragmented_word_ratio(void* self);
double __swift_bridge__$OcrQualityThresholds$min_ocr_mean_confidence(void* self);
uintptr_t __swift_bridge__$OcrQualityThresholds$min_words_for_ocr_output_check(void* self);
double __swift_bridge__$OcrQualityThresholds$max_ocr_output_dict_invalid_word_ratio(void* self);
...
void* __swift_bridge__$SecurityLimits$new(uintptr_t max_archive_size, uintptr_t max_compression_ratio, uintptr_t max_files_in_archive, uintptr_t max_nesting_depth, uintptr_t max_entity_length, uintptr_t max_content_size, uintptr_t max_iterations, uintptr_t max_xml_depth, uintptr_t max_table_cells, struct __private__OptionUsize max_pages);
...
struct __private__OptionUsize __swift_bridge__$SecurityLimits$max_pages(void* self);
...
void* __swift_bridge__$take_xberg_native_pdf_render_warnings(void);
...
struct __private__ResultPtrAndPtr __swift_bridge__$confidence_semantics_from_json(void* json);
...
struct __private__ResultPtrAndPtr __swift_bridge__$page_orientation_handling_from_json(void* json);
...
struct __private__ResultPtrAndPtr __swift_bridge__$pdf_backend_from_json(void* json);
