...
// alef:hash:a95d394cf39143d5c10b6c1f2a0ffb372bd11ea992579055e1fbd8184a03c379
...
public final class SwiftOcrBackendBox {
    ...
    public func alef_confidence_semantics() -> RustString {
        return RustString(String(data: try! JSONEncoder().encode(bridge.confidenceSemantics()), encoding: .utf8)!)
    }
    public func alef_page_orientation_handling() -> RustString {
        return RustString(String(data: try! JSONEncoder().encode(bridge.pageOrientationHandling()), encoding: .utf8)!)
    }
