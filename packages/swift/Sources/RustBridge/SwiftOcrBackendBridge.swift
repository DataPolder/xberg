...
// alef:hash:4eb76234a6ebe82410d53e99299f6b745bea717d91ce2e8b4c49f720ca085e3e
...
public protocol SwiftOcrBackendBridge: SwiftPluginBridge {
    ...
    func confidenceSemantics() -> ConfidenceSemantics
    func pageOrientationHandling() -> PageOrientationHandling
...
final class SwiftOcrBackendAdapter {
    ...
    func confidenceSemanticsCall() -> ConfidenceSemantics {
        let result = self.bridge.confidenceSemantics()
        return result
    }
    func pageOrientationHandlingCall() -> PageOrientationHandling {
