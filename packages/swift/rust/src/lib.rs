...
// alef:hash:048451fc7e0e3b0ca3ab163d2237c243ab6c6dcedde2a19e2dbf1fcfe640c2f1
...
impl SecurityLimits {
    ...
    pub fn new(
        ...
        SecurityLimits(xberg::SecurityLimits {
            ...
            max_xml_depth,
            max_table_cells,
            max_pages: ::std::default::Default::default(),
            ..Default::default()
        })
    }
...
impl From<xberg::PdfBackend> for PdfBackend {
    fn from(val: xberg::PdfBackend) -> Self {
        match val {
            xberg::PdfBackend::PdfOxide => Self::PdfOxide,
...
impl PdfBackend {
    pub fn to_string(&self) -> String {
        match self {
            Self::PdfOxide => "pdf_oxide".to_string(),
...
fn __alef_pdf_backend_from_swift_string(value: &str) -> xberg::PdfBackend {
    match value {
        "pdf_oxide" => xberg::PdfBackend::PdfOxide,
