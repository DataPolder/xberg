...
Extract text, tables, images, metadata, and code intelligence from 101 file formats and 306 programming languages including PDF, Office documents, images, and audio/video transcripts where native transcription is available. Swift bindings via swift-bridge for macOS, iOS, and Linux, with native Swift types and async/await support.
...
```swift
.package(url: "https://github.com/xberg-io/xberg.git", from: "1.0.8"),
```
