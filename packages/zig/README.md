...
Extract text, tables, images, metadata, and code intelligence from 101 file formats and 306 programming languages including PDF, Office documents, images, and audio/video transcripts where native transcription is available. Zig bindings consuming the C FFI surface via @cImport, idiomatic error sets, optional types, and slice-based memory management.
...
```bash
zig fetch --save https://github.com/xberg-io/xberg/archive/refs/tags/v1.0.6.tar.gz
```
