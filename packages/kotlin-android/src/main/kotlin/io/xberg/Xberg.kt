...
// alef:hash:d5c346dbf609e0a515ba61fec81f9358e079b6d997d22dae40f37c836e0917c2
@file:Suppress(
...
object Xberg {
     ...
     */
    fun layoutWastesPlainOutput(layoutEnabled: Boolean, outputFormat: OutputFormat): Boolean = XbergBridge.nativeLayoutWastesPlainOutput(layoutEnabled, mapper.writeValueAsString(outputFormat))
