...
describe("extract", () => {
	...
	it("extract_bytes_input: extract bytes input from PDF document", async () => {
		const result = await extract({ bytes: await (await import("node:fs/promises")).readFile("test_documents/pdf/fake_memo.pdf"), filename: "fake_memo.pdf", kind: "bytes", mimeType: "application/pdf" } as ExtractInput, undefined);
