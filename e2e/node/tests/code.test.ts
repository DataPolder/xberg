...
// alef:hash:15cc8f0e25c1ae550494ee9ad16a2ae0a46a0745cc14ca4224f61f199228ae83
...
describe("code", () => {
	...
	it("code_shebang_detection: Test language detection from shebang line via bytes input", async () => {
		...
		const inputJson = JSON.stringify({ kind: ExtractInputKind.Uri, mimeType: "text/x-source-code", uri: "$mock_url/code/script.sh" } as ExtractInput).replaceAll("$mock_url", inputMockBaseUrl);
