...
// alef:hash:f9cd9e8360a5cdd1572f3857d00d4496bc9bcb7bbd6a77fed115281b5671bdc7
...
fn test_unregister_embedding_backend_after_register() {
    ...
    let _ = unregister_embedding_backend(name).expect("call failed");
}
...
fn test_unregister_post_processor_after_register() {
    ...
    let _ = unregister_post_processor(name).expect("call failed");
}
...
fn test_unregister_reranker_backend() {
    ...
    let _ = unregister_reranker_backend(name).expect("call failed");
}
...
fn test_unregister_tokenizer_backend_after_register() {
    ...
    let _ = unregister_tokenizer_backend(name).expect("call failed");
}
...
fn test_unregister_validator_after_register() {
    ...
    let _ = unregister_validator(name).expect("call failed");
}
